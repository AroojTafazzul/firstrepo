...
<!--		</xsl:if>-->
	...
	<xsl:template name="td-si-hidden-fields">
	 <div class="widgetContainer">
		...
		<xsl:call-template name="hidden-field">
	      ...
	      <xsl:with-param name="value" select="normalize-space(org_previous_file/td_tnx_record/entity)"/>
	    </xsl:call-template>
		<xsl:call-template name="hidden-field">
		...
		<xsl:call-template name="hidden-field">
	    	<xsl:with-param name="name">bank_instruction_indicator</xsl:with-param>
	     	<xsl:with-param name="value" select="counterparties/counterparty[counterparty_type='OPICS_BANK_PAYMENT']/cpty_instruction_indicator"/>
	    </xsl:call-template>
	    <xsl:call-template name="hidden-field">
	    	<xsl:with-param name="name">customer_instruction_indicator</xsl:with-param>
	     	<xsl:with-param name="value" select="counterparties/counterparty[counterparty_type='OPICS_CUSTOMER_PAYMENT']/cpty_instruction_indicator"/>
	    </xsl:call-template>		
    	<xsl:call-template name="hidden-field">
	...
	<xsl:template name="js-imports">
		<xsl:call-template name="common-js-imports">
			<xsl:with-param name="binding">misys.binding.treasury.message_si_td_trtd</xsl:with-param>
			<xsl:with-param name="override-help-access-key">TRTD_02</xsl:with-param>
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template name="hidden-fields">
		<xsl:call-template name="common-hidden-fields">
			...
			<xsl:with-param name="additional-fields">
		        ...
		        -->
		        <xsl:call-template name="hidden-field">
		            <xsl:with-param name="name">td_mode</xsl:with-param>
