...
<xd:doc>
	...
	<xsl:template match="ea_tnx_record">
				...
				<xsl:with-param name="content">						
					...
					<xsl:call-template name="general-details" />
						...
						<div id="transactionDetails">
							...
							<xsl:if test="(sub_tnx_type_code and sub_tnx_type_code = '69') and tnx_type_code and (tnx_type_code[.='32'] or tnx_type_code[.='03']) and (delta_report != '' and delta_report/DltaRpt != '')">
		...
		<!-- Form #1 : Attach Files -->
		<xsl:choose>
			<xsl:when test="(sub_tnx_type_code and sub_tnx_type_code = '69') or ($displaymode = 'edit' or ($displaymode != 'edit' and $mode = 'UNSIGNED'))">
				   <xsl:choose>
					  	 <xsl:when test="(sub_tnx_type_code and sub_tnx_type_code = '69')">
	...
	<xd:doc>
		...
		<xd:detail>
		 The javascript files for EA screen is imported
 		</xd:detail>
	</xd:doc>
	<xsl:template name="js-imports">
		<xsl:call-template name="common-js-imports">
			<xsl:with-param name="binding">misys.binding.openaccount.amend_ea</xsl:with-param>
