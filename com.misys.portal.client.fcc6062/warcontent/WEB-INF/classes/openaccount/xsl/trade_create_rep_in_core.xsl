...
<xsl:include href="../../core/xsl/common/trade_common.xsl" />
	...
	<script type="text/javascript" src="/content/OLD/javascript/openaccount/trade_create_po.js"></script>
			...
			<tr>
				...
				<td>
					<form name="realform" 
						...
						method="POST" 
						action="/gtp/screen/PurchaseOrderScreen" 
						enctype="multipart/form-data">
						
						 <input type="hidden" name="operation" value=""/>
						<input type="hidden" name="mode" value="UNSIGNED"/>
						<input type="hidden" name="tnxtype">
							<xsl:attribute name="value"><xsl:value-of select="tnx_type_code"/></xsl:attribute>
						</input>
