...
Templates for
 ...
 Simplified Invoice Payable Form, Customer Side.
...
email:     kenneth.laurel@misys.com
##########################################################
	-->
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="js-imports">
		<xsl:call-template name="common-js-imports">
			<xsl:with-param name="binding">misys.binding.openaccount.create_simplified_ip</xsl:with-param>
				...
				<xsl:with-param name="content">
					<div class="widgetContainer">
						...
						<xsl:call-template name="hidden-field">
							...
							<xsl:with-param name="value">SMP</xsl:with-param>
						</xsl:call-template>
						<xsl:call-template name="hidden-field">
