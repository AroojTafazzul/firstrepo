...
<xsl:include href="../../core/xsl/common/trade_common.xsl" />
	...
	<td align="left">
		...
		<xsl:if test="count(/ip_tnx_record/routing_summaries/routing_summary/transport_type) != 0">
		...
		<div id="routing_summaries_individual">
			<xsl:attribute name="style">
				<xsl:if test="count(/ip_tnx_record/routing_summaries/routing_summary/transport_type[. = '01']) = 0">display:none</xsl:if>
			</xsl:attribute>
		...
		<div id="routing_summaries_multimodal">
			<xsl:attribute name="style">
				<xsl:if test="count(/ip_tnx_record/routing_summaries/routing_summary/transport_type[. = '02']) = 0">display:none</xsl:if>
			</xsl:attribute>
