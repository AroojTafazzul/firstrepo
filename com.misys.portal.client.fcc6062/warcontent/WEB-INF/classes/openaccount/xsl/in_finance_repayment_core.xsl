...
version:   1.1
date:      16/08/16
author:    Mitchell Angelo, Kenneth Laurel, Jayron Lester Sanchez
...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="js-imports">
		<xsl:call-template name="common-js-imports">
			<xsl:with-param name="binding">misys.binding.openaccount.create_in_repayment</xsl:with-param>
	...
	<xsl:template name="hidden-fields">
		...
		<div class="widgetContainer">
			...
			<xsl:call-template name="hidden-field">
		   	...
		   	<xsl:variable name="counterparty_abbv_name"><xsl:value-of select="buyer_abbv_name" /></xsl:variable>
			<xsl:call-template name="hidden-field">
				<xsl:with-param name="name">bene_access_opened</xsl:with-param>
			    <xsl:with-param name="value"><xsl:value-of select="fscmUtils:getBeneficiaryCollaborationDetails($rundata,$counterparty_abbv_name,'IP','access')"></xsl:value-of></xsl:with-param>
			</xsl:call-template>
			<xsl:call-template name="hidden-field">
				<xsl:with-param name="name">bene_email</xsl:with-param>
			    <xsl:with-param name="value"><xsl:value-of select="fscmUtils:getBeneficiaryCollaborationDetails($rundata,$counterparty_abbv_name,'IP','email')"></xsl:value-of></xsl:with-param>
			</xsl:call-template>
			<xsl:call-template name="hidden-field">
				<xsl:with-param name="name">abbvName</xsl:with-param>
			    <xsl:with-param name="value"><xsl:value-of select="fscmUtils:getBeneficiaryCollaborationDetails($rundata,$counterparty_abbv_name,'IP','beneCompAbbvName')"></xsl:value-of></xsl:with-param>
			</xsl:call-template>
		</div>
	</xsl:template>
