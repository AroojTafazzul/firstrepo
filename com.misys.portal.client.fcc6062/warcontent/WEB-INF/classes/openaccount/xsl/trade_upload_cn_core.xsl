...
Templates for
 ...
 Credit Note (CN) Upload Form, Customer Side.
...
<xsl:stylesheet 
  ...
  <xsl:template name="js-imports">
   <xsl:call-template name="common-js-imports">
    <xsl:with-param name="binding">misys.binding.openaccount.upload_cn</xsl:with-param>
    <xsl:with-param name="override-help-access-key">CN_01_UPL</xsl:with-param>
   </xsl:call-template>
  </xsl:template>
...
<!-- 				<xsl:call-template name="po-general-details" /> -->
   ...
   <xsl:template name="seller-details">
   	<xsl:call-template name="fieldset-wrapper">
    <xsl:with-param name="legend">XSL_HEADER_CN_CUSTOMER_DETAILS</xsl:with-param>
    <xsl:with-param name="content">
	...
	<xsl:template name="template-details">
		<xsl:call-template name="fieldset-wrapper">
			<xsl:with-param name="legend">XSL_HEADER_CN_TEMPLATE_DETAILS</xsl:with-param>
			<xsl:with-param name="content">

				<xsl:call-template name="select-field">
				<xsl:with-param name="label">XSL_CN_UPLOAD_TEMPLATE</xsl:with-param>
		     	...
		     	<xsl:with-param name="options">
		     		<xsl:apply-templates select="upload_templates/upload_template[./product_code='CN']"/>
		     	</xsl:with-param>
		     	<xsl:with-param name="required">Y</xsl:with-param>
				</xsl:call-template>
