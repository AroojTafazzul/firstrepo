	...
	<xsl:template match="io_tnx_record">
		<result>
			<com.misys.portal.openaccount.product.io.common.ImportOpenAccount>
				...
				<!-- This xsl is used for building IO file for incoming processing, when IO is created from the TM message.For this we have total_amt and not fake_total_amt -->
				<xsl:choose>
