...
-->
	...
	<xsl:template match="routingSummaries/routingSummary">
	...
	<xsl:template name="multimodalRS">
		...
		<com.misys.portal.openaccount.product.baseline.common.RoutingSummaryFile>
			<com.misys.portal.openaccount.product.baseline.common.RoutingSummary>
				...
				<xsl:choose>
					<xsl:when test="final_dest_place">
						<xsl:value-of select="final_dest_place"/>
					</xsl:when>
					<xsl:when test="routing_summary_multi_final_dest_place">
						<xsl:value-of select="routing_summary_multi_final_dest_place"/>
					</xsl:when>
				</xsl:choose>
				</place_of_final_destination>
				<taking_in_charge>
				<xsl:choose>
					<xsl:when test="taking_in_charge">
						<xsl:value-of select="taking_in_charge"/>
					</xsl:when>
					<xsl:when test="routing_summary_multi_taking_in_charge">
						<xsl:value-of select="routing_summary_multi_taking_in_charge"/>
					</xsl:when>
				</xsl:choose>
				</taking_in_charge>
				<is_valid>Y</is_valid>
