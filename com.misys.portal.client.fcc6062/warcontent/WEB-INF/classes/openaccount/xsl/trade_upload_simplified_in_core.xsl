...
<!--  <xsl:param name="sub-product-code">SMP</xsl:param>  -->
  ...
  <xsl:template name="js-imports">
   <xsl:call-template name="common-js-imports">
    <xsl:with-param name="binding">misys.binding.openaccount.upload_simplified_in</xsl:with-param>
    <xsl:with-param name="override-help-access-key">IN_01_UPLOAD</xsl:with-param>
   </xsl:call-template>
  </xsl:template>
		...
		<xsl:call-template name="fieldset-wrapper">
			...
			<xsl:with-param name="content">
				...
				<xsl:with-param name="label">XSL_INVOICE_UPLOAD_TEMPLATE</xsl:with-param>
		     	...
		     	<xsl:apply-templates select="upload_templates/upload_template[./product_code='IN' and ./invoice_type='SMP']"/>
		     	</xsl:with-param>
		     	<xsl:with-param name="required">Y</xsl:with-param>
				</xsl:call-template>
