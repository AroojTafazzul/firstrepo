...
<xsl:output method="html" indent="no"/>
	...
	<xsl:param name="section_in_payment_terms"/>
	<xsl:param name="section_in_settlement_terms"/>
	<xsl:param name="section_in_documents_required"/>
	<xsl:param name="section_in_shipment_details"/>
	<xsl:param name="section_in_inco_terms"/>
	<xsl:param name="section_in_routing_summary"/>
	<xsl:param name="section_in_user_info"/>
	<xsl:param name="section_in_contact"/>
	...
	<xsl:template match="in_tnx_record">
		...
		<table border="0" width="570" cellpadding="0" cellspacing="0">
			...
			<xsl:if test="issuer_ref_id[.!='']">
				<tr>
					...
					<td><font class="REPORTDATA"><xsl:value-of select="issuer_ref_id"/></font></td>
				</tr>	
			</xsl:if>
			<tr><td>&nbsp;</td></tr>
			<tr>
		...
		<xsl:if test="$section_in_payment_terms!='N'">
		...
		<xsl:if test="$section_in_settlement_terms!='N'">
		...
		<!--xsl:if test="$section_in_documents_required!='N'">
		...
		<!--Shipment Details-->
		<xsl:if test="$section_in_shipment_details!='N'">
		...
		<xsl:if test="count(/in_tnx_record/routing_summaries/routing_summary) != 0">
		...
		<xsl:if test="$section_in_user_info!='N'">
		...
		<xsl:if test="$section_in_contact!='N'">
