...
<!--
##########################################################
Templates for Invoice Payable Request for Financing, customer side.
...
<xsl:stylesheet 
  ...
  <xsl:template name="js-imports">
   ...
   <xsl:call-template name="common-js-imports">
    <xsl:with-param name="binding">misys.binding.openaccount.financing_request_ip</xsl:with-param>
  ...
  <xsl:template match="ip_tnx_record">
	  ...
	  <!-- Lower case product code -->
	   ...
	   <xsl:variable name="screen-name">InvoicePayableScreen</xsl:variable>
