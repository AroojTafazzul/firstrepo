...
<xsl:stylesheet xmlns:convertTools="xalan://com.misys.portal.common.tools.ConvertTools" 
	...
	<xsl:import href="in_repayment_fo.xsl" />
            ...
            <fo:block white-space-collapse="false">
                <fo:table font-family="{$pdfFontData}" width="{$pdfTableWidth}">
                    ...
                    <fo:table-body>
                        ...
                        <xsl:if test="avail_main_banks/bank/customer_reference/reference != '' or avail_main_banks/bank/entity/customer_reference/reference != ''">
						</xsl:if>
