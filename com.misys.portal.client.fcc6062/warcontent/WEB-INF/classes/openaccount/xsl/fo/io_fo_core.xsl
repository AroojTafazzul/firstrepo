...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="io_content_fo.xsl"/>
    <xd:doc>
    	<xd:short>Sets layout of Pdf file for IO Screen</xd:short>
    	<xd:detail>
    	This templates sets layout for the PDF file for IO screen,It adds various attributes of margin of pdf(top,bottom.right.left) and 
