  ...
  <xsl:template name="body">
    <fo:flow flow-name="xsl-region-body" font-size="{$pdfFontSize}">
            ...
            <xsl:value-of select="seller_reference"/>
						...
						<xsl:if test="seller_reference[.!=''] and count(//*/avail_main_banks/bank/entity/customer_reference[reference=$seller_ref]) &gt; 0">							
							<xsl:call-template name="table_cell">
								<xsl:with-param name="left_text">
            ...
            <xsl:value-of select="buyer_reference"/>
						...
						<xsl:if test="buyer_reference[.!=''] and count(//*/avail_main_banks/bank/entity/customer_reference[reference=$buyer_ref]) &gt; 0">
							...
							<fo:table-row keep-with-previous="always">
								...
								<fo:table-cell>
									<fo:block font-weight="bold">
										<xsl:choose>
                                            <xsl:when test="count(//*/avail_main_banks/bank/entity/customer_reference[reference=$seller_ref]) >= 1 or count(//*/avail_main_banks/bank/entity/customer_reference) >= 1">
                                                   <xsl:value-of select="//*/avail_main_banks/bank/entity/customer_reference/description"/>
                                            </xsl:when>
                                            <xsl:when test="count(//*/avail_main_banks/bank/entity/customer_reference[reference=$seller_ref]) = 0 or count(//*/avail_main_banks/bank/entity/customer_reference) = 0">
