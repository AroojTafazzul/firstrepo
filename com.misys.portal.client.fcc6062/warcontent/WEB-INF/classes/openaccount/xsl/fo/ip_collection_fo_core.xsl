...
<xsl:stylesheet xmlns:convertTools="xalan://com.misys.portal.common.tools.ConvertTools" 
  ...
  <xsl:template name="settlement">
   <fo:flow flow-name="xsl-region-body" font-size="{$pdfFontSize}">
            <xsl:choose>
                <xsl:when test="tnx_type_code[.='85'] or tnx_type_code[.='13']">
                        ...
                        <fo:table-row keep-with-previous="always">
                         ...
                         <xsl:if test="due_date[.!='']">
                            <fo:table-row keep-with-previous="always">
                                <fo:table-cell>
                                    <fo:block font-family="{$pdfFont}" start-indent="20.0pt">
                                        <xsl:value-of select="localization:getGTPString($language, 'XSL_GENERALDETAILS_INVOICE_DUE_DATE')"/>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block font-weight="bold">
                          ...
                          <xsl:if test="settlement_date[.!='']">
                            <fo:table-row keep-with-previous="always">
                                <fo:table-cell>
                                    <fo:block font-family="{$pdfFont}" start-indent="20.0pt">
                                        <xsl:value-of select="localization:getGTPString($language, 'XSL_GENERALDETAILS_INVOICE_SETTLEMENT_DATE')"/>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block font-weight="bold">
...
<!-- 										<xsl:value-of select="seller_street_name"/> -->
			...
			<!--Invoice Settlement amount Details-->
			<fo:block keep-together="always">
                <fo:table font-family="{$pdfFontData}" width="{$pdfTableWidth}">
                    <fo:table-column column-width="{$labelColumnWidth}"/>
                    <fo:table-column column-width="{$detailsColumnWidth}"/>
                    <fo:table-body>
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2">
                                <fo:block background-color="{$backgroundTitles}" color="{$fontColorTitles}" font-family="{$pdfFont}" font-weight="bold" space-before.optimum="10.0pt">
                                    <xsl:value-of select="localization:getGTPString($language, 'XSL_SETTLEMENT_AMOUNT_DETAILS')"/>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
					 ...
					 <xsl:if test="liab_total_net_amt[.!='']">
                            <fo:table-row keep-with-previous="always">
                                <fo:table-cell>
                                    <fo:block font-family="{$pdfFont}" start-indent="20.0pt">
                                        <xsl:value-of select="localization:getGTPString($language, 'XSL_OUTSTANDING_AMOUNT')"/>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block font-weight="bold">
                      ...
                      <xsl:if test="settlement_amt[.!='']">
                            <fo:table-row keep-with-previous="always">
                                <fo:table-cell>
                                    <fo:block font-family="{$pdfFont}" start-indent="20.0pt">
                                        <xsl:value-of select="localization:getGTPString($language, 'XSL_SETTLEMENT_AMOUNT')"/>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block font-weight="bold">
					  ...
					  <xsl:if test="settlement_percentage[.!='']">
                            <fo:table-row keep-with-previous="always">
                                <fo:table-cell>
                                    <fo:block font-family="{$pdfFont}" start-indent="20.0pt">
                                        <xsl:value-of select="localization:getGTPString($language, 'XSL_SETTLEMENT_PERCENTAGE')"/>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block font-weight="bold">
