...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- Retrieve references from DB -->
		...
		<xsl:variable name="references" select="tools:manageReferences('PO', //ref_id, //tnx_id, //bo_ref_id, //bo_tnx_id, //cust_ref_id, //company_id, //company_name, //buyer_reference, //issuing_bank/abbv_name, '01')"/>
		...
		<xsl:variable name="product_code">PO</xsl:variable>
		<xsl:variable name="customer_bank_reference" select="$references/references/customer_bank_reference"/>
		<result>
			<com.misys.portal.openaccount.product.po.common.PurchaseOrder>
				...
				<xsl:if test="(routing_summaries/rs_tnx_record/final_dest_place or routing_summaries/rs_tnx_record/taking_in_charge) and (routing_summaries/rs_tnx_record/final_dest_place != '' and routing_summaries/rs_tnx_record/taking_in_charge != '')">
