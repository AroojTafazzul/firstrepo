...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- Retrieve references from DB -->
		...
		<xsl:variable name="references" select="tools:manageReferences('IP', //ref_id, //tnx_id, //bo_ref_id, //bo_tnx_id, //cust_ref_id, //company_id, //company_name, //buyer_reference, //issuing_bank/abbv_name, '01')"/>
