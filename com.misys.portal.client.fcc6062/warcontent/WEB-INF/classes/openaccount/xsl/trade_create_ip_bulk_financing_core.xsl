...
<xsl:stylesheet 
	...
	<xsl:include href="../../core/xsl/bk_invoice_payable.xsl"/>
...
<!-- 
	...
	<xsl:if test="$displaymode='edit'">
		<xsl:call-template name="bulk_invoice_payables"/>					
		<xsl:call-template name="bulk-invoice-payable-grid">
			<xsl:with-param name="product">IP</xsl:with-param>
		</xsl:call-template>
	</xsl:if>	
	<xsl:if test="$displaymode='view'">
		<xsl:call-template name="bulk_invoice_payables"/>					
		<xsl:call-template name="bulk-invoice-grid-view">
			<xsl:with-param name="product">IP</xsl:with-param>
		</xsl:call-template>
	</xsl:if>			
	</div>
	...
	<xsl:call-template name="fieldset-wrapper">
      ...
      <xsl:choose>
		...
		<xsl:call-template name="common-js-imports">
			<xsl:with-param name="binding">misys.binding.openaccount.create_ip_bk</xsl:with-param>
