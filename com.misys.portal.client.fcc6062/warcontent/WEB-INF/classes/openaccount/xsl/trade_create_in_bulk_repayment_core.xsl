...
Transaction Bulk (BK) Repayment for IN from Customer Side.
...
<!-- 
	...
	<xsl:template match="bk_tnx_record">
				...
				<xsl:with-param name="content">
					...
					<xsl:call-template name="reauthentication" />
												...
												<xsl:with-param name="content">
													...
													<xsl:if test="entities[number(.) &gt; 0]">
									  					<xsl:call-template name="entity-field">
										    				...
										    				<xsl:with-param name="override-sub-product-code">BK:INBR</xsl:with-param>
									    				</xsl:call-template>
													</xsl:if>
												</xsl:with-param>
											</xsl:call-template>
						...
						<xsl:call-template name="bulk_finances_repay">
							<xsl:with-param name="childProduct">IN</xsl:with-param>
						</xsl:call-template>
						<xsl:choose>
		...
		<xsl:call-template name="common-js-imports">
			<xsl:with-param name="binding">misys.binding.openaccount.create_in_bk_repayment</xsl:with-param>
			<xsl:with-param name="override-help-access-key">BK_INBR_01</xsl:with-param>
		</xsl:call-template>
			...
			<xsl:with-param name="content">
				<div class="widgetContainer">
					...
					<xsl:call-template name="hidden-field">
						...
						<xsl:with-param name="value">INBR</xsl:with-param>
					</xsl:call-template>
					<xsl:call-template name="hidden-field">
