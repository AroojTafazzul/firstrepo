...
<!--
##########################################################
Review screen for multiple finance request IN, Customer Side.
				...
				<table style="width:100%">
					  ...
					  <thead>
				       <tr>
				        ...
				        <th class="multiSubmissionListHeader userAccountColumnCell" scope="col" style="width:20%;padding-bottom: 8px;text-align:center"><xsl:value-of select="localization:getGTPString($language, 'BUYER_NAME')"/></th>
