...
<xsl:stylesheet 
	...
	<xsl:include href="../../core/xsl/bk_invoice.xsl"/>
...
<!-- 
	...
	<xsl:if test="$displaymode='edit'">
		<xsl:call-template name="bulk_invoices"/>
		<xsl:call-template name="bulk-invoice-grid">
			<xsl:with-param name="product">IN</xsl:with-param>
		</xsl:call-template>
	</xsl:if>	
    ...
    <xsl:call-template name="fieldset-wrapper">
      ...
      <xsl:choose>
		...
		<xsl:call-template name="common-js-imports">
			<xsl:with-param name="binding">misys.binding.openaccount.create_in_bk</xsl:with-param>
