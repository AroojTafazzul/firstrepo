...
<xsl:stylesheet 
  ...
  <!-- All marks used to shown/hidden form's sections-->
	...
	<xsl:param name="section_po_user_info">N</xsl:param>
	...
	<xsl:param name="section_line_item_po_reference">Y</xsl:param>	
				...
				<xsl:choose>
					<xsl:when test="$displaymode = 'edit' or ($displaymode != 'edit' and $mode = 'UNSIGNED')">
						<xsl:call-template name="attachments-file-dojo">
							<xsl:with-param name="attachment-group">invoice-payable</xsl:with-param>
						</xsl:call-template>
					</xsl:when>
					<xsl:otherwise>
						<xsl:call-template name="attachments-file-dojo">
 ...
 <xsl:template name="js-imports">
  <xsl:call-template name="common-js-imports">
   <xsl:with-param name="binding">misys.binding.bank.report_ip</xsl:with-param>
   ...
   <xsl:with-param name="content">
	...
	<xsl:template name="goods-details">
		<xsl:call-template name="common-goods-details" >
			<xsl:with-param name="section_po_line_items">Y</xsl:with-param>
		</xsl:call-template>
	</xsl:template>
