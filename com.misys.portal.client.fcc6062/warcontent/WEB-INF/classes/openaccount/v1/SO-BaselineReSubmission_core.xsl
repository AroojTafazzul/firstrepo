...
<xsl:stylesheet 
	...
	xmlns:Doc="urn:swift:xsd:$tsmt.012.001.02"
	...
	<xsl:template match="so_tnx_record">						
		<tu_tnx_record xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.neomalogic.com/gtp/interfaces/xsd/tu.xsd">
			...
			<!-- TSU MESSAGE -->
			<narrative_xml>
			&lt;Doc:Document xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:Doc="urn:swift:xsd:$tsmt.012.001.02">
			&lt;Doc:tsmt.012.001.02>
				&lt;Doc:SubmissnId>
				...
				&lt;Doc:Baseln>
					&lt;Doc:SubmitrBaselnId>
						...
						&lt;Doc:Vrsn>0&lt;/Doc:Vrsn>
						&lt;Doc:Submitr>
							&lt;Doc:BIC><xsl:value-of select="advising_bank/iso_code"/>&lt;/Doc:BIC>
						&lt;/Doc:Submitr>
					&lt;/Doc:SubmitrBaselnId>
					&lt;Doc:SvcCd>LEV1&lt;/Doc:SvcCd>
					&lt;Doc:PurchsOrdrRef>
						&lt;Doc:Id><xsl:value-of select="po_ref_id"/>&lt;/Doc:Id>
					...
					&lt;Doc:SellrBk>
						&lt;Doc:BIC><xsl:choose>
							...
							<xsl:when test="seller_bank_type_code[.='01']"><xsl:value-of select="issuing_bank/iso_code"/></xsl:when>
							<xsl:when test="seller_bank_type_code[.='02']"><xsl:value-of select="advising_bank/iso_code"/></xsl:when>
							<xsl:otherwise/>
						</xsl:choose>&lt;/Doc:BIC>
					&lt;/Doc:SellrBk>
					...
					&lt;Doc:DataSetReqrd>
						...
						&lt;Doc:Submitr>
							&lt;Doc:BIC><xsl:value-of select="seller_bank/iso_code"/>&lt;/Doc:BIC>
						&lt;/Doc:Submitr>
						&lt;/Doc:DataSetReqrd>
						&lt;/Doc:Baseln>
						<!-- Buyer Contact -->
