...
<xsl:stylesheet 
	...
	<xsl:template match="po_tnx_record">
		...
		<xsl:variable name="invoiceReference"></xsl:variable>
		...
		<tu_tnx_record xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.neomalogic.com/gtp/interfaces/xsd/tu.xsd">
			...
			<!-- TSU MESSAGE -->
			<narrative_xml>
			&lt;Doc:Document xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:Doc="urn:swift:xsd:$tsmt.020.001.01">
			&lt;Doc:tsmt.020.001.01>
				&lt;Doc:AccptncId>
				...
				&lt;/Doc:TxId>
				&lt;Doc:SubmitrTxRef>
					&lt;Doc:Id><xsl:value-of select="tnx_id"/>&lt;/Doc:Id>
					&lt;Doc:IdIssr>
						&lt;Doc:BIC>
							<!-- submit by buyer -->
					...
					&lt;/Doc:IdIssr>
				&lt;/Doc:SubmitrTxRef>
				&lt;Doc:DataSetMtchRptRef>
					<!-- TODO : retrieve DataSetMatchReport (through cross refs) -->
					<!--
					&lt;Doc:Id><xsl:value-of select="idgenerator:generate('TU')"/>&lt;/Doc:Id>
					&lt;Doc:CreDtTm><xsl:value-of select="tools:getW3CIsoDateTime()"/>&lt;/Doc:CreDtTm>
					-->
