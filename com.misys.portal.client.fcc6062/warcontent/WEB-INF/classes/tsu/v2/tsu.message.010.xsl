...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		...
		<xsl:variable name="isSeller" select="tools:isSeller($bicCode,//BaselnMtchRpt/SellrBk/BIC,//BaselnMtchRpt/BuyrBk/BIC,$messageDetails)"/>
		...
		<xsl:variable name="bankDetailsFromBuyerBic" select="tools:retrieveBankDetailsFromBICCode(//BaselnMtchRpt/BuyrBk/BIC)" />
		<xsl:variable name="bankDetailsFromSellerBic" select="tools:retrieveBankDetailsFromBICCode(//BaselnMtchRpt/SellrBk/BIC)" />
