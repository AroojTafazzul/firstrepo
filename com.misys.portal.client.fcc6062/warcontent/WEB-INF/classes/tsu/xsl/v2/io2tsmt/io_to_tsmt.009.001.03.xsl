			...
			<Baseln>
				...
				<Goods>
					...
					<LineItmsTtlAmt>
						...
						<xsl:variable name="total_amt"> <xsl:value-of select="total_amt"/></xsl:variable>
					...
					<TtlNetAmt>
						...
						<xsl:variable name="total_net_amt"> <xsl:value-of select="total_net_amt"/></xsl:variable>
				...
				<PmtTerms>
				 ...
				 <SttlmTerms>  
					...
					<CdtrAcct>
					<xsl:if test="(seller_account_iban and seller_account_iban!='') or (seller_account_bban and seller_account_bban!='') or (seller_account_upic and seller_account_upic!='') or (seller_account_id and seller_account_id!='') ">
					<Id>
						<xsl:choose>
		      ...
		      <xsl:if test="bank_payment_obligation/PmtOblgtn">
    			...
    			<xsl:if test="last_match_date and last_match_date !=''">
    				<LatstMtchDt>
    					<xsl:variable name="last_match_date"><xsl:value-of select="last_match_date"/></xsl:variable>
	...
	<LineItmDtls>
		...
		<xsl:if test="price_amt and price_amt !=''">
			<UnitPric>
				...
				<Amt>
					 <xsl:attribute name="Ccy"><xsl:value-of select="price_cur_code" /> </xsl:attribute>
					 <xsl:variable name="price_amt"> <xsl:value-of select="price_amt"/></xsl:variable>
	...
	<xsl:template match="payments/payment">
		...
		<xsl:choose>
			...
			<Amt>
				...
				<xsl:variable name="amt"> <xsl:value-of select="amt"/></xsl:variable>
	...
	<xsl:template match="bank_payment_obligation/PmtOblgtn">
		<PmtOblgtn>    					
			...
			<xsl:if test="ChrgsAmt and ChrgsAmt !=''">
				<ChrgsAmt>
						<xsl:attribute name="Ccy">
	               		 	<xsl:value-of select="ChrgsAmt/@Ccy"/>
	           			</xsl:attribute>
						<xsl:variable name="ChrgsAmt"> <xsl:value-of select="ChrgsAmt"/></xsl:variable>
			...
			<xsl:if test="PmtTerms">
				<PmtTerms>
					<xsl:if test="PmtTerms/OthrPmtTerms and PmtTerms/OthrPmtTerms!=''">
							<xsl:copy-of select="PmtTerms/OthrPmtTerms"/>
					</xsl:if>
					<xsl:if test="PmtTerms/PmtCd/Cd and PmtTerms/PmtCd/Cd!=''">
						<PmtCd>
							<xsl:copy-of select="PmtTerms/PmtCd/Cd"/>
							<xsl:if test="PmtTerms/PmtCd/NbOfDays and PmtTerms/PmtCd/NbOfDays!=''">
									<xsl:copy-of select="PmtTerms/PmtCd/NbOfDays"/>
							</xsl:if>
						</PmtCd>
					</xsl:if>
					<xsl:choose>
						<xsl:when test="PmtTerms/Pctg and PmtTerms/Pctg!=''">
								<xsl:copy-of select="PmtTerms/Pctg"/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:copy-of select="PmtTerms/Amt"/>
						</xsl:otherwise>
					</xsl:choose>
				</PmtTerms>
			</xsl:if>
			
			<xsl:if test="SttlmTerms">
				<SttlmTerms>
					 <xsl:if test="(SttlmTerms/CdtrAgt/BIC or SttlmTerms/CdtrAgt/Nm) and (SttlmTerms/CdtrAgt/BIC!='' or SttlmTerms/CdtrAgt/Nm!='')">
						<CdtrAgt>
							<xsl:if test="SttlmTerms/CdtrAgt/BIC and SttlmTerms/CdtrAgt/BIC!=''">
								<xsl:copy-of select="SttlmTerms/CdtrAgt/BIC"/>
							</xsl:if>
							<xsl:if test="(SttlmTerms/CdtrAgt/NmAndAdr/Nm or SttlmTerms/CdtrAgt/NmAndAdr/Adr/PstCdId) and (SttlmTerms/CdtrAgt/NmAndAdr/Nm!='' or SttlmTerms/CdtrAgt/NmAndAdr/Adr/PstCdId!='')">	
								<NmAndAdr>
									<xsl:if test="SttlmTerms/CdtrAgt/NmAndAdr/Nm and SttlmTerms/CdtrAgt/NmAndAdr/Nm!=''">	
										<xsl:copy-of select="SttlmTerms/CdtrAgt/NmAndAdr/Nm"/>
									</xsl:if>
									<xsl:if test="SttlmTerms/CdtrAgt/NmAndAdr/Adr/PstCdId and SttlmTerms/CdtrAgt/NmAndAdr/Adr/PstCdId!=''">	
										<Adr>
											<xsl:if test="SttlmTerms/CdtrAgt/NmAndAdr/Adr/StrtNm and SttlmTerms/CdtrAgt/NmAndAdr/Adr/StrtNm!=''">	
												<xsl:copy-of select="SttlmTerms/CdtrAgt/NmAndAdr/Adr/StrtNm"/>
											</xsl:if>
											<xsl:if test="SttlmTerms/CdtrAgt/NmAndAdr/Adr/PstCdId and SttlmTerms/CdtrAgt/NmAndAdr/Adr/PstCdId!=''">	
												<xsl:copy-of select="SttlmTerms/CdtrAgt/NmAndAdr/Adr/PstCdId"/>
											</xsl:if>
											<xsl:if test="SttlmTerms/CdtrAgt/NmAndAdr/Adr/TwnNm and SttlmTerms/CdtrAgt/NmAndAdr/Adr/TwnNm!=''">	
												<xsl:copy-of select="SttlmTerms/CdtrAgt/NmAndAdr/Adr/TwnNm"/>
											</xsl:if>
											<xsl:if test="SttlmTerms/CdtrAgt/NmAndAdr/Adr/CtrySubDvsn and SttlmTerms/CdtrAgt/NmAndAdr/Adr/CtrySubDvsn!=''">	
												<xsl:copy-of select="SttlmTerms/CdtrAgt/NmAndAdr/Adr/CtrySubDvsn"/>
											</xsl:if>
											<xsl:if test="SttlmTerms/CdtrAgt/NmAndAdr/Adr/Ctry and SttlmTerms/CdtrAgt/NmAndAdr/Adr/Ctry!=''">	
												<xsl:copy-of select="SttlmTerms/CdtrAgt/NmAndAdr/Adr/Ctry"/>
											</xsl:if>
										</Adr>
									</xsl:if>
								</NmAndAdr>
					...
					<CdtrAcct>
						<xsl:if test="(SttlmTerms/CdtrAcct/Id/IBAN and SttlmTerms/CdtrAcct/Id/IBAN!='') or (SttlmTerms/CdtrAcct/Id/BBAN and SttlmTerms/CdtrAcct/Id/BBAN!='') or (SttlmTerms/CdtrAcct/Id/UPIC and SttlmTerms/CdtrAcct/Id/UPIC!='') or (SttlmTerms/CdtrAcct/Id/PrtryAcct/Id and SttlmTerms/CdtrAcct/Id/PrtryAcct/Id!='') ">
							<Id>
								<xsl:if test="SttlmTerms/CdtrAcct/Id/IBAN and SttlmTerms/CdtrAcct/Id/IBAN!=''">
									<xsl:copy-of select="SttlmTerms/CdtrAcct/Id/IBAN"/>
								</xsl:if>
								<xsl:if test="SttlmTerms/CdtrAcct/Id/BBAN and SttlmTerms/CdtrAcct/Id/BBAN!=''">
									<xsl:copy-of select="SttlmTerms/CdtrAcct/Id/BBAN"/>
								</xsl:if>
								<xsl:if test="SttlmTerms/CdtrAcct/Id/UPIC and SttlmTerms/CdtrAcct/Id/UPIC!=''">
									<xsl:copy-of select="SttlmTerms/CdtrAcct/Id/UPIC"/>
								</xsl:if>
								<xsl:if test="SttlmTerms/CdtrAcct/Id/PrtryAcct/Id and SttlmTerms/CdtrAcct/Id/PrtryAcct/Id!=''">
									<xsl:copy-of select="SttlmTerms/CdtrAcct/Id/PrtryAcct"/>
								</xsl:if>
							</Id>
						</xsl:if>
						<xsl:if test="(SttlmTerms/CdtrAcct/Tp/Cd or SttlmTerms/CdtrAcct/Tp/Prtry) and (SttlmTerms/CdtrAcct/Tp/Cd!='' or SttlmTerms/CdtrAcct/Tp/Prtry!='')">
							<Tp>
								<xsl:if test="SttlmTerms/CdtrAcct/Tp/Cd  and SttlmTerms/CdtrAcct/Tp/Cd!=''">
									<xsl:copy-of select="SttlmTerms/CdtrAcct/Tp/Cd"/>
								</xsl:if>
								<xsl:if test="SttlmTerms/CdtrAcct/Tp/Prtry  and SttlmTerms/CdtrAcct/Tp/Prtry!=''">
									<xsl:copy-of select="SttlmTerms/CdtrAcct/Tp/Prtry"/>
								</xsl:if>
							</Tp>
						</xsl:if>
						
						<xsl:if test="SttlmTerms/CdtrAcct/Ccy and SttlmTerms/CdtrAcct/Ccy!=''">
							<xsl:copy-of select="SttlmTerms/CdtrAcct/Ccy"/>
						</xsl:if>
						<xsl:if test="SttlmTerms/CdtrAcct/Nm and SttlmTerms/CdtrAcct/Nm!=''">
							<xsl:copy-of select="SttlmTerms/CdtrAcct/Nm"/>
						</xsl:if>
				</CdtrAcct>
		</SttlmTerms>	
	</xsl:if>
	...
	<xsl:template match="shipment_schedules/shipment_schedule">
		<ShipmntSubSchdl>
			...
			<xsl:if test="schedule_earliest_ship_date and schedule_earliest_ship_date!=''">
				<EarlstShipmntDt>
								<xsl:variable name="earliest_ship_date"><xsl:value-of select="schedule_earliest_ship_date"/></xsl:variable>
    							<xsl:value-of select="tools:getCurrentTMAFormatDate($earliest_ship_date,'simpleDate')"/> 
				</EarlstShipmntDt>
			</xsl:if>
			<xsl:if test="schedule_latest_ship_date and schedule_latest_ship_date!=''">
				<LatstShipmntDt>
								<xsl:variable name="last_ship_date"><xsl:value-of select="schedule_latest_ship_date"></xsl:value-of></xsl:variable>
    							<xsl:value-of select="tools:getCurrentTMAFormatDate($last_ship_date,'simpleDate')"/>
				</LatstShipmntDt>
			</xsl:if>
		</ShipmntSubSchdl>
