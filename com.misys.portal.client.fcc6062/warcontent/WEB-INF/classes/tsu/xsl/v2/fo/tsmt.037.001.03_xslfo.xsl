...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::StsRpt) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:block id="XSL_TSU_StsRpt_name"/>
</xsl:if>
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RptId) &lt; 1 and count(../preceding-sibling::StsRpt) &lt; 1">
<fo:block id="XSL_TSU_StsRpt_StatusReportV03_StsRpt_RptId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportV03_RptId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RltdMsgRef) &lt; 1 and count(../preceding-sibling::StsRpt) &lt; 1">
<fo:block id="XSL_TSU_StsRpt_StatusReportV03_StsRpt_RltdMsgRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportV03_RltdMsgRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RptdItms) &lt; 1 and count(../preceding-sibling::StsRpt) &lt; 1">
<fo:block id="XSL_TSU_StsRpt_StatusReportV03_StsRpt_RptdItms_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportV03_RptdItms_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RptdNtty) &lt; 1 and count(../preceding-sibling::RptdItms) &lt; 1">
<fo:block id="XSL_TSU_StsRpt_StatusReportItems2_RptdItms_RptdNtty_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_RptdNtty_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:choose>
<xsl:when test=". = 'PROP'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_PROP')"/>
</xsl:when>
<xsl:when test=". = 'CLSD'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_CLSD')"/>
</xsl:when>
<xsl:when test=". = 'PMTC'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_PMTC')"/>
</xsl:when>
<xsl:when test=". = 'ESTD'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_ESTD')"/>
</xsl:when>
<xsl:when test=". = 'ACTV'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_ACTV')"/>
</xsl:when>
<xsl:when test=". = 'COMP'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_COMP')"/>
</xsl:when>
<xsl:when test=". = 'AMRQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_AMRQ')"/>
</xsl:when>
<xsl:when test=". = 'RARQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_RARQ')"/>
</xsl:when>
<xsl:when test=". = 'CLRQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_CLRQ')"/>
</xsl:when>
<xsl:when test=". = 'SCRQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_SCRQ')"/>
</xsl:when>
<xsl:when test=". = 'SERQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_SERQ')"/>
</xsl:when>
<xsl:when test=". = 'DARQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_Sts_code_DARQ')"/>
</xsl:when>
</xsl:choose>
</xsl:with-param>
</xsl:call-template>
...
<xsl:apply-templates select="StsRpt" mode="toc">
<xsl:with-param name="path" select="concat($path,'/Document')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/StsRpt" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="StsRpt"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::StsRpt) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsRpt_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="StsRpt/RptId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="RptId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RptId) &lt; 1 and count(../preceding-sibling::StsRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsRpt_StatusReportV03_StsRpt_RptId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportV03_RptId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="StsRpt/RltdMsgRef" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="RltdMsgRef"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RltdMsgRef) &lt; 1 and count(../preceding-sibling::StsRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsRpt_StatusReportV03_StsRpt_RltdMsgRef_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportV03_RltdMsgRef_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="StsRpt/RptdItms" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="RptdItms"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RptdItms) &lt; 1 and count(../preceding-sibling::StsRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsRpt_StatusReportV03_StsRpt_RptdItms_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportV03_RptdItms_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:apply-templates select="SubSts" mode="toc">
<xsl:with-param name="path" select="concat($path,'/RptdItms[', $index,']')"/>
<xsl:with-param name="readOnly"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:template match="RptdItms/RptdNtty" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="RptdNtty"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RptdNtty) &lt; 1 and count(../preceding-sibling::RptdItms) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsRpt_StatusReportItems2_RptdItms_RptdNtty_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRpt_StatusReportItems2_RptdNtty_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="RptdItms/Sts" mode="toc">
<xsl:param name="path"/>
<xsl:param name="readOnly"/>
<xsl:variable name="index">
<xsl:number count="Sts"/>
...
<xsl:template match="RptdItms/SubSts" mode="toc">
<xsl:param name="path"/>
<xsl:param name="readOnly"/>
<xsl:variable name="index">
<xsl:number count="SubSts"/>
