...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RoleAndBaselnRjctn) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:block id="XSL_TSU_RoleAndBaselnRjctn_name"/>
</xsl:if>
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_RoleAndBaselnRjctn_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RjctnId) &lt; 1 and count(../preceding-sibling::RoleAndBaselnRjctn) &lt; 1">
<fo:block id="XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RoleAndBaselnRjctn_RjctnId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RjctnId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RltdMsgRef) &lt; 1 and count(../preceding-sibling::RoleAndBaselnRjctn) &lt; 1">
<fo:block id="XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RoleAndBaselnRjctn_RltdMsgRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RltdMsgRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::RoleAndBaselnRjctn) &lt; 1">
<fo:block id="XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RoleAndBaselnRjctn_TxId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_TxId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RjctnRsn) &lt; 1 and count(../preceding-sibling::RoleAndBaselnRjctn) &lt; 1">
<fo:block id="XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RoleAndBaselnRjctn_RjctnRsn_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RjctnRsn_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:apply-templates select="RoleAndBaselnRjctn" mode="toc">
<xsl:with-param name="path" select="concat($path,'/Document')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/RoleAndBaselnRjctn" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="RoleAndBaselnRjctn"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RoleAndBaselnRjctn) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_RoleAndBaselnRjctn_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_RoleAndBaselnRjctn_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="RoleAndBaselnRjctn/RjctnId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="RjctnId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RjctnId) &lt; 1 and count(../preceding-sibling::RoleAndBaselnRjctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RoleAndBaselnRjctn_RjctnId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RjctnId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="RoleAndBaselnRjctn/RltdMsgRef" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="RltdMsgRef"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RltdMsgRef) &lt; 1 and count(../preceding-sibling::RoleAndBaselnRjctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RoleAndBaselnRjctn_RltdMsgRef_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RltdMsgRef_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="RoleAndBaselnRjctn/TxId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="TxId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::RoleAndBaselnRjctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RoleAndBaselnRjctn_TxId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_TxId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="RoleAndBaselnRjctn/RjctnRsn" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="RjctnRsn"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RjctnRsn) &lt; 1 and count(../preceding-sibling::RoleAndBaselnRjctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RoleAndBaselnRjctn_RjctnRsn_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_RoleAndBaselnRjctn_RoleAndBaselineRejectionV01_RjctnRsn_name')"/>
</fo:bookmark-title>
</fo:bookmark>
