...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::DataSetMtchRpt) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_name"/>
</xsl:if>
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RptId) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_RptId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_RptId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_TxId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_TxId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::EstblishdBaselnId) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_EstblishdBaselnId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_EstblishdBaselnId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxSts) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_TxSts_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_TxSts_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:choose>
<xsl:when test=". = 'PROP'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_PROP')"/>
</xsl:when>
<xsl:when test=". = 'CLSD'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_CLSD')"/>
</xsl:when>
<xsl:when test=". = 'PMTC'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_PMTC')"/>
</xsl:when>
<xsl:when test=". = 'ESTD'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_ESTD')"/>
</xsl:when>
<xsl:when test=". = 'ACTV'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_ACTV')"/>
</xsl:when>
<xsl:when test=". = 'COMP'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_COMP')"/>
</xsl:when>
<xsl:when test=". = 'AMRQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_AMRQ')"/>
</xsl:when>
<xsl:when test=". = 'RARQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_RARQ')"/>
</xsl:when>
<xsl:when test=". = 'CLRQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_CLRQ')"/>
</xsl:when>
<xsl:when test=". = 'SCRQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_SCRQ')"/>
</xsl:when>
<xsl:when test=". = 'SERQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_SERQ')"/>
</xsl:when>
<xsl:when test=". = 'DARQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_TransactionStatus4_Sts_code_DARQ')"/>
</xsl:when>
</xsl:choose>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::UsrTxRef) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_UsrTxRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_UsrTxRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_DataSetMtchRpt_DocumentIdentification5_UsrTxRef_IdIssr_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DocumentIdentification5_IdIssr_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::Buyr) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_Buyr_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_Buyr_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_DataSetMtchRpt_PartyIdentification26_Buyr_PrtryId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PartyIdentification26_PrtryId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_DataSetMtchRpt_PartyIdentification26_Buyr_PstlAdr_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PartyIdentification26_PstlAdr_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::Sellr) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_Sellr_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_Sellr_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_DataSetMtchRpt_PartyIdentification26_Sellr_PrtryId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<fo:block id="XSL_TSU_DataSetMtchRpt_PartyIdentification26_Sellr_PstlAdr_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::BuyrBk) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_BuyrBk_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_BuyrBk_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SellrBk) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_SellrBk_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_SellrBk_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::CmpardDocRef) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_CmpardDocRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_CmpardDocRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:choose>
<xsl:when test=". = 'BASE'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DocumentIdentification10_Tp_code_BASE')"/>
</xsl:when>
<xsl:when test=". = 'TRDS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DocumentIdentification10_Tp_code_TRDS')"/>
</xsl:when>
<xsl:when test=". = 'CODS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DocumentIdentification10_Tp_code_CODS')"/>
</xsl:when>
<xsl:when test=". = 'INDS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DocumentIdentification10_Tp_code_INDS')"/>
</xsl:when>
<xsl:when test=". = 'CEDS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DocumentIdentification10_Tp_code_CEDS')"/>
</xsl:when>
<xsl:when test=". = 'OCDS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DocumentIdentification10_Tp_code_OCDS')"/>
</xsl:when>
</xsl:choose>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_DataSetMtchRpt_DocumentIdentification10_CmpardDocRef_Submitr_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DocumentIdentification10_Submitr_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SubmissnTp) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_SubmissnTp_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_SubmissnTp_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:choose>
<xsl:when test=". = 'MTCH'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_ReportType3_Tp_code_MTCH')"/>
</xsl:when>
<xsl:when test=". = 'PMTC'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_ReportType3_Tp_code_PMTC')"/>
</xsl:when>
</xsl:choose>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::Rpt) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_Rpt_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_Rpt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_DataSetMtchRpt_MisMatchReport3_Rpt_MisMtchInf_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_MisMatchReport3_MisMtchInf_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_DataSetMtchRpt_ValidationResult5_MisMtchInf_MisMtchdElmt_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_ValidationResult5_MisMtchdElmt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ReqForActn) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:block id="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_ReqForActn_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_ReqForActn_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:choose>
<xsl:when test=". = 'SBTW'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_SBTW')"/>
</xsl:when>
<xsl:when test=". = 'RSTW'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_RSTW')"/>
</xsl:when>
<xsl:when test=". = 'RSBS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_RSBS')"/>
</xsl:when>
<xsl:when test=". = 'ARDM'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_ARDM')"/>
</xsl:when>
<xsl:when test=". = 'ARCS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_ARCS')"/>
</xsl:when>
<xsl:when test=". = 'ARES'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_ARES')"/>
</xsl:when>
<xsl:when test=". = 'WAIT'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_WAIT')"/>
</xsl:when>
<xsl:when test=". = 'UPDT'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_UPDT')"/>
</xsl:when>
<xsl:when test=". = 'SBDS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_SBDS')"/>
</xsl:when>
<xsl:when test=". = 'ARBA'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_ARBA')"/>
</xsl:when>
<xsl:when test=". = 'ARRO'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_ARRO')"/>
</xsl:when>
<xsl:when test=". = 'CINR'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PendingActivity2_Tp_code_CINR')"/>
</xsl:when>
</xsl:choose>
</xsl:with-param>
</xsl:call-template>
...
<xsl:apply-templates select="DataSetMtchRpt" mode="toc">
<xsl:with-param name="path" select="concat($path,'/Document')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/DataSetMtchRpt" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="DataSetMtchRpt"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::DataSetMtchRpt) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:apply-templates select="SubmissnTp" mode="toc">
<xsl:with-param name="path" select="concat($path,'/DataSetMtchRpt')"/>
<xsl:with-param name="readOnly"/>
</xsl:apply-templates>
...
<xsl:template match="DataSetMtchRpt/RptId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="RptId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::RptId) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_RptId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_RptId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="DataSetMtchRpt/TxId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="TxId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_TxId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_TxId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="DataSetMtchRpt/EstblishdBaselnId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="EstblishdBaselnId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::EstblishdBaselnId) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_EstblishdBaselnId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_EstblishdBaselnId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="DataSetMtchRpt/TxSts" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="TxSts"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxSts) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_TxSts_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_TxSts_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="DataSetMtchRpt/UsrTxRef" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="UsrTxRef"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::UsrTxRef) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_UsrTxRef_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_UsrTxRef_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::IdIssr) &lt; 1 and count(../preceding-sibling::UsrTxRef) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DocumentIdentification5_UsrTxRef_IdIssr_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DocumentIdentification5_IdIssr_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="DataSetMtchRpt/Buyr" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="Buyr"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::Buyr) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_Buyr_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_Buyr_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::PrtryId) &lt; 1 and count(../preceding-sibling::Buyr) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_PartyIdentification26_Buyr_PrtryId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PartyIdentification26_PrtryId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::PstlAdr) &lt; 1 and count(../preceding-sibling::Buyr) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_PartyIdentification26_Buyr_PstlAdr_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PartyIdentification26_PstlAdr_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="DataSetMtchRpt/Sellr" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="Sellr"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::Sellr) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_Sellr_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_Sellr_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::PrtryId) &lt; 1 and count(../preceding-sibling::Sellr) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_PartyIdentification26_Sellr_PrtryId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PartyIdentification26_PrtryId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::PstlAdr) &lt; 1 and count(../preceding-sibling::Sellr) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_PartyIdentification26_Sellr_PstlAdr_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_PartyIdentification26_PstlAdr_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="DataSetMtchRpt/BuyrBk" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="BuyrBk"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::BuyrBk) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_BuyrBk_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_BuyrBk_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="DataSetMtchRpt/SellrBk" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="SellrBk"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SellrBk) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_SellrBk_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_SellrBk_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="DataSetMtchRpt/CmpardDocRef" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="CmpardDocRef"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::CmpardDocRef) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_CmpardDocRef_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_CmpardDocRef_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="CmpardDocRef/Tp" mode="toc">
<xsl:param name="path"/>
<xsl:param name="readOnly"/>
<xsl:variable name="index">
<xsl:number count="Tp"/>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::Submitr) &lt; 1 and count(../preceding-sibling::CmpardDocRef) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DocumentIdentification10_CmpardDocRef_Submitr_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DocumentIdentification10_Submitr_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="DataSetMtchRpt/SubmissnTp" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="SubmissnTp"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SubmissnTp) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_SubmissnTp_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_SubmissnTp_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="SubmissnTp/Tp" mode="toc">
<xsl:param name="path"/>
<xsl:param name="readOnly"/>
<xsl:variable name="index">
<xsl:number count="Tp"/>
...
<xsl:template match="DataSetMtchRpt/Rpt" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="Rpt"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::Rpt) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_Rpt_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_Rpt_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::MisMtchInf) &lt; 1 and count(../preceding-sibling::Rpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_MisMatchReport3_Rpt_MisMtchInf_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_MisMatchReport3_MisMtchInf_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::MisMtchdElmt) &lt; 1 and count(../preceding-sibling::MisMtchInf) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_ValidationResult5_MisMtchInf_MisMtchdElmt_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_ValidationResult5_MisMtchdElmt_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="DataSetMtchRpt/ReqForActn" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="ReqForActn"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ReqForActn) &lt; 1 and count(../preceding-sibling::DataSetMtchRpt) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_DataSetMtchRpt_ReqForActn_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_DataSetMtchRpt_DataSetMatchReportV03_ReqForActn_name')"/>
</fo:bookmark-title>
</fo:bookmark>
