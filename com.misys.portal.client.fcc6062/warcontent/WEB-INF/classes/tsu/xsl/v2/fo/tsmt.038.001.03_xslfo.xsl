...
<xsl:apply-templates select="StsRptReq">
<xsl:with-param name="path">g
                  </xsl:with-param>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/StsRptReq">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="StsRptReq"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::StsRptReq) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:block id="XSL_TSU_StsRptReq_name"/>
</xsl:if>
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRptReq_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
<xsl:apply-templates select="ReqId">
<xsl:with-param name="path" select="concat($path,'/StsRptReq')"/>
</xsl:apply-templates>
<xsl:apply-templates select="NttiesToBeRptd">
<xsl:with-param name="path" select="concat($path,'/StsRptReq')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="StsRptReq/ReqId">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="ReqId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ReqId) &lt; 1 and count(../preceding-sibling::StsRptReq) &lt; 1">
<fo:block id="XSL_TSU_StsRptReq_StatusReportRequestV03_StsRptReq_ReqId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRptReq_StatusReportRequestV03_ReqId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:variable name="label">XSL_TSU_StsRptReq_MessageIdentification1_Id_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
...
<xsl:variable name="label">XSL_TSU_StsRptReq_MessageIdentification1_CreDtTm_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="table_cell">
<xsl:with-param name="left_text">
...
<xsl:template match="StsRptReq/NttiesToBeRptd">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="NttiesToBeRptd"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::NttiesToBeRptd) &lt; 1 and count(../preceding-sibling::StsRptReq) &lt; 1">
<fo:block id="XSL_TSU_StsRptReq_StatusReportRequestV03_StsRptReq_NttiesToBeRptd_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRptReq_StatusReportRequestV03_NttiesToBeRptd_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:variable name="label">XSL_TSU_StsRptReq_BICIdentification1_BIC_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="table_cell">
<xsl:with-param name="left_text">
...
<xsl:apply-templates select="StsRptReq" mode="toc">
<xsl:with-param name="path" select="concat($path,'/Document')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/StsRptReq" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="StsRptReq"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::StsRptReq) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsRptReq_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRptReq_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="StsRptReq/ReqId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="ReqId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ReqId) &lt; 1 and count(../preceding-sibling::StsRptReq) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsRptReq_StatusReportRequestV03_StsRptReq_ReqId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRptReq_StatusReportRequestV03_ReqId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="StsRptReq/NttiesToBeRptd" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="NttiesToBeRptd"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::NttiesToBeRptd) &lt; 1 and count(../preceding-sibling::StsRptReq) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsRptReq_StatusReportRequestV03_StsRptReq_NttiesToBeRptd_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsRptReq_StatusReportRequestV03_NttiesToBeRptd_name')"/>
</fo:bookmark-title>
</fo:bookmark>
