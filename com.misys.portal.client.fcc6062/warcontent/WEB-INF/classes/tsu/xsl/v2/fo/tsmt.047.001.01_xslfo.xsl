...
<xsl:apply-templates select="SpclReq">
<xsl:with-param name="path">g
                  </xsl:with-param>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/SpclReq">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="SpclReq"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SpclReq) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:block id="XSL_TSU_SpclReq_name"/>
</xsl:if>
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
<xsl:apply-templates select="ReqId">
<xsl:with-param name="path" select="concat($path,'/SpclReq')"/>
</xsl:apply-templates>
...
<xsl:template match="SpclReq/ReqId">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="ReqId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ReqId) &lt; 1 and count(../preceding-sibling::SpclReq) &lt; 1">
<fo:block id="XSL_TSU_SpclReq_SpecialRequestV01_SpclReq_ReqId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_SpecialRequestV01_ReqId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:variable name="label">XSL_TSU_SpclReq_MessageIdentification1_Id_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
...
<xsl:variable name="label">XSL_TSU_SpclReq_MessageIdentification1_CreDtTm_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="table_cell">
<xsl:with-param name="left_text">
...
<xsl:template match="SpclReq/TxId">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="TxId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::SpclReq) &lt; 1">
<fo:block id="XSL_TSU_SpclReq_SpecialRequestV01_SpclReq_TxId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_SpecialRequestV01_TxId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:variable name="label">XSL_TSU_SpclReq_SimpleIdentificationInformation_Id_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="table_cell">
<xsl:with-param name="left_text">
...
<xsl:template match="SpclReq/SubmitrTxRef">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="SubmitrTxRef"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SubmitrTxRef) &lt; 1 and count(../preceding-sibling::SpclReq) &lt; 1">
<fo:block id="XSL_TSU_SpclReq_SpecialRequestV01_SpclReq_SubmitrTxRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_SpecialRequestV01_SubmitrTxRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:template match="SpclReq/Ntfctn">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="Ntfctn"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::Ntfctn) &lt; 1 and count(../preceding-sibling::SpclReq) &lt; 1">
<fo:block id="XSL_TSU_SpclReq_SpecialRequestV01_SpclReq_Ntfctn_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_SpecialRequestV01_Ntfctn_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:variable name="label">XSL_TSU_SpclReq_Notification1_Tp_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="table_cell">
<xsl:with-param name="left_text">
...
<xsl:choose>
<xsl:when test=". = 'MWFT'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_Notification1_Tp_code_MWFT')"/>
</xsl:when>
<xsl:when test=". = 'CSDS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_Notification1_Tp_code_CSDS')"/>
</xsl:when>
</xsl:choose>
</xsl:with-param>
</xsl:call-template>
...
<xsl:variable name="label">XSL_TSU_SpclReq_Notification1_AddtlInf_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="table_cell">
<xsl:with-param name="left_text">
...
<xsl:apply-templates select="SpclReq" mode="toc">
<xsl:with-param name="path" select="concat($path,'/Document')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/SpclReq" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="SpclReq"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SpclReq) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_SpclReq_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="SpclReq/ReqId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="ReqId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ReqId) &lt; 1 and count(../preceding-sibling::SpclReq) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_SpclReq_SpecialRequestV01_SpclReq_ReqId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_SpecialRequestV01_ReqId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="SpclReq/TxId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="TxId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::SpclReq) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_SpclReq_SpecialRequestV01_SpclReq_TxId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_SpecialRequestV01_TxId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="SpclReq/SubmitrTxRef" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="SubmitrTxRef"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SubmitrTxRef) &lt; 1 and count(../preceding-sibling::SpclReq) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_SpclReq_SpecialRequestV01_SpclReq_SubmitrTxRef_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_SpecialRequestV01_SubmitrTxRef_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="SpclReq/Ntfctn" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="Ntfctn"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::Ntfctn) &lt; 1 and count(../preceding-sibling::SpclReq) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_SpclReq_SpecialRequestV01_SpclReq_Ntfctn_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_SpclReq_SpecialRequestV01_Ntfctn_name')"/>
</fo:bookmark-title>
</fo:bookmark>
