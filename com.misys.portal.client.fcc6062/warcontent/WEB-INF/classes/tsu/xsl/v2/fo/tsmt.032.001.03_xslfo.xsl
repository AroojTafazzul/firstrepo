...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::StsXtnsnNtfctn) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:block id="XSL_TSU_StsXtnsnNtfctn_name"/>
</xsl:if>
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::NtfctnId) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:block id="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_NtfctnId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_NtfctnId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:block id="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_TxId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_TxId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::EstblishdBaselnId) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:block id="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_EstblishdBaselnId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_EstblishdBaselnId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::UsrTxRef) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:block id="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_UsrTxRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_UsrTxRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_StsXtnsnNtfctn_DocumentIdentification5_UsrTxRef_IdIssr_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_DocumentIdentification5_IdIssr_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::XtndedSts) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:block id="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_XtndedSts_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_XtndedSts_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:choose>
<xsl:when test=". = 'PROP'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_PROP')"/>
</xsl:when>
<xsl:when test=". = 'CLSD'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_CLSD')"/>
</xsl:when>
<xsl:when test=". = 'PMTC'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_PMTC')"/>
</xsl:when>
<xsl:when test=". = 'ESTD'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_ESTD')"/>
</xsl:when>
<xsl:when test=". = 'ACTV'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_ACTV')"/>
</xsl:when>
<xsl:when test=". = 'COMP'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_COMP')"/>
</xsl:when>
<xsl:when test=". = 'AMRQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_AMRQ')"/>
</xsl:when>
<xsl:when test=". = 'RARQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_RARQ')"/>
</xsl:when>
<xsl:when test=". = 'CLRQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_CLRQ')"/>
</xsl:when>
<xsl:when test=". = 'SCRQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_SCRQ')"/>
</xsl:when>
<xsl:when test=". = 'SERQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_SERQ')"/>
</xsl:when>
<xsl:when test=". = 'DARQ'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_TransactionStatus5_Sts_code_DARQ')"/>
</xsl:when>
</xsl:choose>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ReqForActn) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:block id="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_ReqForActn_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_ReqForActn_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:choose>
<xsl:when test=". = 'SBTW'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_SBTW')"/>
</xsl:when>
<xsl:when test=". = 'RSTW'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_RSTW')"/>
</xsl:when>
<xsl:when test=". = 'RSBS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_RSBS')"/>
</xsl:when>
<xsl:when test=". = 'ARDM'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_ARDM')"/>
</xsl:when>
<xsl:when test=". = 'ARCS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_ARCS')"/>
</xsl:when>
<xsl:when test=". = 'ARES'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_ARES')"/>
</xsl:when>
<xsl:when test=". = 'WAIT'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_WAIT')"/>
</xsl:when>
<xsl:when test=". = 'UPDT'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_UPDT')"/>
</xsl:when>
<xsl:when test=". = 'SBDS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_SBDS')"/>
</xsl:when>
<xsl:when test=". = 'ARBA'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_ARBA')"/>
</xsl:when>
<xsl:when test=". = 'ARRO'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_ARRO')"/>
</xsl:when>
<xsl:when test=". = 'CINR'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_PendingActivity2_Tp_code_CINR')"/>
</xsl:when>
</xsl:choose>
</xsl:with-param>
</xsl:call-template>
...
<xsl:apply-templates select="StsXtnsnNtfctn" mode="toc">
<xsl:with-param name="path" select="concat($path,'/Document')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/StsXtnsnNtfctn" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="StsXtnsnNtfctn"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::StsXtnsnNtfctn) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsXtnsnNtfctn_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="StsXtnsnNtfctn/NtfctnId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="NtfctnId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::NtfctnId) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_NtfctnId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_NtfctnId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="StsXtnsnNtfctn/TxId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="TxId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_TxId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_TxId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="StsXtnsnNtfctn/EstblishdBaselnId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="EstblishdBaselnId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::EstblishdBaselnId) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_EstblishdBaselnId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_EstblishdBaselnId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="StsXtnsnNtfctn/UsrTxRef" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="UsrTxRef"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::UsrTxRef) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_UsrTxRef_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_UsrTxRef_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::IdIssr) &lt; 1 and count(../preceding-sibling::UsrTxRef) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsXtnsnNtfctn_DocumentIdentification5_UsrTxRef_IdIssr_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_DocumentIdentification5_IdIssr_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="StsXtnsnNtfctn/XtndedSts" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="XtndedSts"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::XtndedSts) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_XtndedSts_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_XtndedSts_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="XtndedSts/ChngDtTm" mode="toc">
<xsl:param name="path"/>
<xsl:param name="readOnly"/>
<xsl:variable name="index">
<xsl:number count="ChngDtTm"/>
...
<xsl:template match="XtndedSts/Desc" mode="toc">
<xsl:param name="path"/>
<xsl:param name="readOnly"/>
<xsl:variable name="index">
<xsl:number count="Desc"/>
...
<xsl:template match="StsXtnsnNtfctn/ReqForActn" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="ReqForActn"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ReqForActn) &lt; 1 and count(../preceding-sibling::StsXtnsnNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_StsXtnsnNtfctn_ReqForActn_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_StsXtnsnNtfctn_StatusExtensionNotificationV03_ReqForActn_name')"/>
</fo:bookmark-title>
</fo:bookmark>
