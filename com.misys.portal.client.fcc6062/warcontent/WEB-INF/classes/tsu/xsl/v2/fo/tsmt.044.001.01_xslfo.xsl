...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::InttToPayNtfctn) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:block id="XSL_TSU_InttToPayNtfctn_name"/>
</xsl:if>
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::NtfctnId) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:block id="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_NtfctnId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_NtfctnId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:block id="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_TxId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_TxId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SubmitrTxRef) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:block id="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_SubmitrTxRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_SubmitrTxRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::BuyrBk) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:block id="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_BuyrBk_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_BuyrBk_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SellrBk) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:block id="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_SellrBk_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_SellrBk_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::InttToPay) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:block id="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_InttToPay_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPay_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_IntentToPay1_InttToPay_SttlmTerms_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPay1_SttlmTerms_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_SettlementTerms2_SttlmTerms_CdtrAgt_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_SettlementTerms2_CdtrAgt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_FinancialInstitutionIdentification4Choice_CdtrAgt_NmAndAdr_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_FinancialInstitutionIdentification4Choice_NmAndAdr_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_NameAndAddress6_NmAndAdr_Adr_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_NameAndAddress6_Adr_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_SettlementTerms2_SttlmTerms_CdtrAcct_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_SettlementTerms2_CdtrAcct_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_CashAccount7_CdtrAcct_Id_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccount7_Id_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_AccountIdentification3Choice_Id_PrtryAcct_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_AccountIdentification3Choice_PrtryAcct_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_CashAccount7_CdtrAcct_Tp_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccount7_Tp_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:choose>
<xsl:when test=". = 'CASH'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_CASH')"/>
</xsl:when>
<xsl:when test=". = 'CHAR'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_CHAR')"/>
</xsl:when>
<xsl:when test=". = 'COMM'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_COMM')"/>
</xsl:when>
<xsl:when test=". = 'TAXE'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_TAXE')"/>
</xsl:when>
<xsl:when test=". = 'CISH'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_CISH')"/>
</xsl:when>
<xsl:when test=". = 'TRAS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_TRAS')"/>
</xsl:when>
<xsl:when test=". = 'SACC'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_SACC')"/>
</xsl:when>
<xsl:when test=". = 'CACC'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_CACC')"/>
</xsl:when>
<xsl:when test=". = 'SVGS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_SVGS')"/>
</xsl:when>
<xsl:when test=". = 'ONDP'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_ONDP')"/>
</xsl:when>
<xsl:when test=". = 'MGLD'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_MGLD')"/>
</xsl:when>
<xsl:when test=". = 'NREX'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_NREX')"/>
</xsl:when>
<xsl:when test=". = 'MOMA'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_MOMA')"/>
</xsl:when>
<xsl:when test=". = 'LOAN'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_LOAN')"/>
</xsl:when>
<xsl:when test=". = 'SLRY'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_SLRY')"/>
</xsl:when>
<xsl:when test=". = 'ODFT'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccountType2_Cd_code_ODFT')"/>
</xsl:when>
</xsl:choose>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_IntentToPay1_InttToPay_ByPurchsOrdr_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPay1_ByPurchsOrdr_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_ReportLine3_ByPurchsOrdr_PurchsOrdrRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_ReportLine3_PurchsOrdrRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_ReportLine3_ByPurchsOrdr_Adjstmnt_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_ReportLine3_Adjstmnt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:choose>
<xsl:when test=". = 'ADDD'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_Adjustment4_Drctn_code_ADDD')"/>
</xsl:when>
<xsl:when test=". = 'SUBS'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_Adjustment4_Drctn_code_SUBS')"/>
</xsl:when>
</xsl:choose>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_Adjustment4_Adjstmnt_Amt_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_Adjustment4_Amt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:choose>
<xsl:when test=". = 'REBA'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_Adjustment4_Tp_code_REBA')"/>
</xsl:when>
<xsl:when test=". = 'DISC'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_Adjustment4_Tp_code_DISC')"/>
</xsl:when>
<xsl:when test=". = 'CREN'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_Adjustment4_Tp_code_CREN')"/>
</xsl:when>
<xsl:when test=". = 'SURC'">
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_Adjustment4_Tp_code_SURC')"/>
</xsl:when>
</xsl:choose>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_ReportLine3_ByPurchsOrdr_NetAmt_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_ReportLine3_NetAmt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_IntentToPay1_InttToPay_ByComrclInvc_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPay1_ByComrclInvc_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_ReportLine4_ByComrclInvc_ComrclDocRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_ReportLine4_ComrclDocRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:variable name="label">XSL_TSU_InttToPayNtfctn_InvoiceIdentification1_InvcNb_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="table_cell">
<xsl:with-param name="left_text">
...
<xsl:variable name="label">XSL_TSU_InttToPayNtfctn_InvoiceIdentification1_IsseDt_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="table_cell">
<xsl:with-param name="left_text">
...
<fo:block id="XSL_TSU_InttToPayNtfctn_ReportLine4_ByComrclInvc_Adjstmnt_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_ReportLine4_Adjstmnt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_ReportLine4_ByComrclInvc_NetAmt_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_ReportLine4_NetAmt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_ReportLine4_ByComrclInvc_BrkdwnByPurchsOrdr_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_ReportLine4_BrkdwnByPurchsOrdr_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_ReportLine2_BrkdwnByPurchsOrdr_PurchsOrdrRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_ReportLine2_PurchsOrdrRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_ReportLine2_BrkdwnByPurchsOrdr_Adjstmnt_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_ReportLine2_Adjstmnt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<fo:block id="XSL_TSU_InttToPayNtfctn_ReportLine2_BrkdwnByPurchsOrdr_NetAmt_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_ReportLine2_NetAmt_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:apply-templates select="InttToPayNtfctn" mode="toc">
<xsl:with-param name="path" select="concat($path,'/Document')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/InttToPayNtfctn" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="InttToPayNtfctn"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::InttToPayNtfctn) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="InttToPayNtfctn/NtfctnId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="NtfctnId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::NtfctnId) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_NtfctnId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_NtfctnId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="InttToPayNtfctn/TxId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="TxId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_TxId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_TxId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="InttToPayNtfctn/SubmitrTxRef" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="SubmitrTxRef"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SubmitrTxRef) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_SubmitrTxRef_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_SubmitrTxRef_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="InttToPayNtfctn/BuyrBk" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="BuyrBk"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::BuyrBk) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_BuyrBk_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_BuyrBk_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="InttToPayNtfctn/SellrBk" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="SellrBk"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SellrBk) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_SellrBk_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_SellrBk_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="InttToPayNtfctn/InttToPay" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="InttToPay"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::InttToPay) &lt; 1 and count(../preceding-sibling::InttToPayNtfctn) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPayNtfctn_InttToPay_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPayNotificationV01_InttToPay_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SttlmTerms) &lt; 1 and count(../preceding-sibling::InttToPay) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_IntentToPay1_InttToPay_SttlmTerms_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_IntentToPay1_SttlmTerms_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::CdtrAgt) &lt; 1 and count(../preceding-sibling::SttlmTerms) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_SettlementTerms2_SttlmTerms_CdtrAgt_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_SettlementTerms2_CdtrAgt_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::CdtrAcct) &lt; 1 and count(../preceding-sibling::SttlmTerms) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_SettlementTerms2_SttlmTerms_CdtrAcct_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_SettlementTerms2_CdtrAcct_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::Id) &lt; 1 and count(../preceding-sibling::CdtrAcct) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_CashAccount7_CdtrAcct_Id_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccount7_Id_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::Tp) &lt; 1 and count(../preceding-sibling::CdtrAcct) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_InttToPayNtfctn_CashAccount7_CdtrAcct_Tp_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_InttToPayNtfctn_CashAccount7_Tp_name')"/>
</fo:bookmark-title>
</fo:bookmark>
