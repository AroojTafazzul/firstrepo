...
<xsl:apply-templates select="ActvtyRptSetUpReq">
<xsl:with-param name="path">g
                  </xsl:with-param>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/ActvtyRptSetUpReq">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="ActvtyRptSetUpReq"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ActvtyRptSetUpReq) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:block id="XSL_TSU_ActvtyRptSetUpReq_name"/>
</xsl:if>
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_ActvtyRptSetUpReq_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
<xsl:apply-templates select="ReqId">
<xsl:with-param name="path" select="concat($path,'/ActvtyRptSetUpReq')"/>
</xsl:apply-templates>
<xsl:apply-templates select="UTCOffset">
<xsl:with-param name="path" select="concat($path,'/ActvtyRptSetUpReq')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="ActvtyRptSetUpReq/ReqId">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="ReqId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ReqId) &lt; 1 and count(../preceding-sibling::ActvtyRptSetUpReq) &lt; 1">
<fo:block id="XSL_TSU_ActvtyRptSetUpReq_ActivityReportSetUpRequestV02_ActvtyRptSetUpReq_ReqId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_ActvtyRptSetUpReq_ActivityReportSetUpRequestV02_ReqId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:variable name="label">XSL_TSU_ActvtyRptSetUpReq_MessageIdentification1_Id_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
...
<xsl:variable name="label">XSL_TSU_ActvtyRptSetUpReq_MessageIdentification1_CreDtTm_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="table_cell">
<xsl:with-param name="left_text">
...
<xsl:template match="ActvtyRptSetUpReq/UTCOffset">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="UTCOffset"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::UTCOffset) &lt; 1 and count(../preceding-sibling::ActvtyRptSetUpReq) &lt; 1">
<fo:block id="XSL_TSU_ActvtyRptSetUpReq_ActivityReportSetUpRequestV02_ActvtyRptSetUpReq_UTCOffset_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_ActvtyRptSetUpReq_ActivityReportSetUpRequestV02_UTCOffset_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
<xsl:apply-templates select="Sgn">
<xsl:with-param name="path" select="concat($path,'/UTCOffset')"/>
</xsl:apply-templates>
<xsl:apply-templates select="NbOfHrs">
<xsl:with-param name="path" select="concat($path,'/UTCOffset')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="UTCOffset/Sgn">
<xsl:param name="path"/>
<xsl:param name="readOnly"/>
<xsl:variable name="index">
<xsl:number count="Sgn"/>
</xsl:variable>
<xsl:variable name="label">XSL_TSU_ActvtyRptSetUpReq_UTCOffset1_Sgn_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="table_cell">
<xsl:with-param name="left_text">
...
<xsl:template match="UTCOffset/NbOfHrs">
<xsl:param name="path"/>
<xsl:param name="readOnly"/>
<xsl:variable name="index">
<xsl:number count="NbOfHrs"/>
</xsl:variable>
<xsl:variable name="label">XSL_TSU_ActvtyRptSetUpReq_UTCOffset1_NbOfHrs_name</xsl:variable>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="table_cell">
<xsl:with-param name="left_text">
...
<xsl:apply-templates select="ActvtyRptSetUpReq" mode="toc">
<xsl:with-param name="path" select="concat($path,'/Document')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/ActvtyRptSetUpReq" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="ActvtyRptSetUpReq"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ActvtyRptSetUpReq) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_ActvtyRptSetUpReq_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_ActvtyRptSetUpReq_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:apply-templates select="UTCOffset" mode="toc">
<xsl:with-param name="path" select="concat($path,'/ActvtyRptSetUpReq')"/>
<xsl:with-param name="readOnly"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="ActvtyRptSetUpReq/ReqId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="ReqId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::ReqId) &lt; 1 and count(../preceding-sibling::ActvtyRptSetUpReq) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_ActvtyRptSetUpReq_ActivityReportSetUpRequestV02_ActvtyRptSetUpReq_ReqId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_ActvtyRptSetUpReq_ActivityReportSetUpRequestV02_ReqId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="ActvtyRptSetUpReq/UTCOffset" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="UTCOffset"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::UTCOffset) &lt; 1 and count(../preceding-sibling::ActvtyRptSetUpReq) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_ActvtyRptSetUpReq_ActivityReportSetUpRequestV02_ActvtyRptSetUpReq_UTCOffset_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_ActvtyRptSetUpReq_ActivityReportSetUpRequestV02_UTCOffset_name')"/>
</fo:bookmark-title>
</fo:bookmark>
</xsl:if>
<xsl:apply-templates select="Sgn" mode="toc">
<xsl:with-param name="path" select="concat($path,'/UTCOffset')"/>
<xsl:with-param name="readOnly"/>
</xsl:apply-templates>
<xsl:apply-templates select="NbOfHrs" mode="toc">
<xsl:with-param name="path" select="concat($path,'/UTCOffset')"/>
<xsl:with-param name="readOnly"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="UTCOffset/Sgn" mode="toc">
<xsl:param name="path"/>
<xsl:param name="readOnly"/>
<xsl:variable name="index">
<xsl:number count="Sgn"/>
...
<xsl:template match="UTCOffset/NbOfHrs" mode="toc">
<xsl:param name="path"/>
<xsl:param name="readOnly"/>
<xsl:variable name="index">
<xsl:number count="NbOfHrs"/>
