...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::MisMtchAccptnc) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:block id="XSL_TSU_MisMtchAccptnc_name"/>
</xsl:if>
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_MisMtchAccptnc_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::AccptncId) &lt; 1 and count(../preceding-sibling::MisMtchAccptnc) &lt; 1">
<fo:block id="XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_MisMtchAccptnc_AccptncId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_AccptncId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::MisMtchAccptnc) &lt; 1">
<fo:block id="XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_MisMtchAccptnc_TxId_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_TxId_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SubmitrTxRef) &lt; 1 and count(../preceding-sibling::MisMtchAccptnc) &lt; 1">
<fo:block id="XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_MisMtchAccptnc_SubmitrTxRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_SubmitrTxRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::DataSetMtchRptRef) &lt; 1 and count(../preceding-sibling::MisMtchAccptnc) &lt; 1">
<fo:block id="XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_MisMtchAccptnc_DataSetMtchRptRef_name"/>
</xsl:if>
<xsl:call-template name="table_template">
<xsl:with-param name="text">
<xsl:call-template name="subtitle">
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_DataSetMtchRptRef_name')"/>
</xsl:with-param>
</xsl:call-template>
</xsl:with-param>
</xsl:call-template>
...
<xsl:apply-templates select="MisMtchAccptnc" mode="toc">
<xsl:with-param name="path" select="concat($path,'/Document')"/>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="Document/MisMtchAccptnc" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="MisMtchAccptnc"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::MisMtchAccptnc) &lt; 1 and count(../preceding-sibling::Document) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_MisMtchAccptnc_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_MisMtchAccptnc_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="MisMtchAccptnc/AccptncId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="AccptncId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::AccptncId) &lt; 1 and count(../preceding-sibling::MisMtchAccptnc) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_MisMtchAccptnc_AccptncId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_AccptncId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="MisMtchAccptnc/TxId" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="TxId"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::TxId) &lt; 1 and count(../preceding-sibling::MisMtchAccptnc) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_MisMtchAccptnc_TxId_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_TxId_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="MisMtchAccptnc/SubmitrTxRef" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="SubmitrTxRef"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::SubmitrTxRef) &lt; 1 and count(../preceding-sibling::MisMtchAccptnc) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_MisMtchAccptnc_SubmitrTxRef_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_SubmitrTxRef_name')"/>
</fo:bookmark-title>
</fo:bookmark>
...
<xsl:template match="MisMtchAccptnc/DataSetMtchRptRef" mode="toc">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="DataSetMtchRptRef"/>
</xsl:variable>
<xsl:if test="count(ancestor::*) &lt; 6 and count(preceding-sibling::DataSetMtchRptRef) &lt; 1 and count(../preceding-sibling::MisMtchAccptnc) &lt; 1">
<fo:bookmark internal-destination="XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_MisMtchAccptnc_DataSetMtchRptRef_name">
<fo:bookmark-title>
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_MisMtchAccptnc_MisMatchAcceptanceV02_DataSetMtchRptRef_name')"/>
</fo:bookmark-title>
</fo:bookmark>
