...
<xsl:with-param name="legend">XSL_TSU_AmdmntRjctn_AmendmentRejectionV02_SubmitrTxRef_name</xsl:with-param>
...
<xsl:with-param name="help-label">XSL_TSU_AmdmntRjctn_SimpleIdentificationInformation_Id_definition</xsl:with-param>
</xsl:call-template>
</div>
</div>
</xsl:with-param>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_AmdmntRjctn_RejectedElement1_ElmtSeqNb_definition</xsl:with-param>
</xsl:call-template>
</div>
<div class="formField">
...
<xsl:with-param name="required">Y</xsl:with-param>
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_AmdmntRjctn_RejectedElement1_IndvRjctnRsn_definition</xsl:with-param>
</xsl:call-template>
</div>
</div>
</xsl:with-param>
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_AmdmntRjctn_name</xsl:with-param>
<xsl:with-param name="legend-type">indented-header</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_AmdmntRjctn_AmendmentRejectionV02_RjctnId_name</xsl:with-param>
<xsl:with-param name="legend-type">indented-header</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_AmdmntRjctn_MessageIdentification1_Id_definition</xsl:with-param>
</xsl:call-template>
</div>
</xsl:template>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_AmdmntRjctn_MessageIdentification1_CreDtTm_definition</xsl:with-param>
</xsl:call-template>
</div>
</xsl:template>
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_AmdmntRjctn_AmendmentRejectionV02_TxId_name</xsl:with-param>
<xsl:with-param name="legend-type">indented-header</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
<xsl:apply-templates select="Id">
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_AmdmntRjctn_AmendmentRejectionV02_DltaRptRef_name</xsl:with-param>
<xsl:with-param name="legend-type">indented-header</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
<xsl:apply-templates select="Id">
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_AmdmntRjctn_AmendmentRejectionV02_RjctdAmdmntNb_name</xsl:with-param>
<xsl:with-param name="legend-type">indented-header</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_AmdmntRjctn_Count1_Nb_definition</xsl:with-param>
</xsl:call-template>
</div>
</xsl:template>
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_AmdmntRjctn_AmendmentRejectionV02_RjctnRsn_name</xsl:with-param>
<xsl:with-param name="legend-type">indented-header</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
<xsl:call-template name="AmdmntRjctn_RjctnRsn_GblRjctnRsn_RjctdElmt_choice">
...
<xsl:template name="AmdmntRjctn_RjctnRsn_GblRjctnRsn_RjctdElmt_choice">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="RjctnRsn"/>
</xsl:variable>
...
<xsl:variable name="label">XSL_TSU_AmdmntRjctn_RejectionReason1Choice_GblRjctnRsn_name</xsl:variable>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_AmdmntRjctn_Reason2_Desc_definition</xsl:with-param>
</xsl:call-template>
</div>
<div class="formField">
...
<xsl:value-of select="&#10;              localization:getGTPString($language, 'XSL_TSU_AmdmntRjctn_Reason2_Desc_name')&#10;            "/>
</label>
...
<xsl:value-of select="localization:getGTPString($language, 'XSL_TSU_AmdmntRjctn_Reason2_Desc_definition')"/>
</xsl:attribute>
</img>
</div>
</div>
...
<xsl:variable name="label">XSL_TSU_AmdmntRjctn_RejectionReason1Choice_RjctdElmt_name</xsl:variable>
<xsl:call-template name="radio-field">
<xsl:with-param name="label">
<xsl:value-of select="$label"/>
</xsl:with-param>
