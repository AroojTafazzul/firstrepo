...
<xsl:call-template name="Document_InitlBaselnSubmissn_BuyrBkCtctPrsn_SellrBkCtctPrsn_choice">
<xsl:with-param name="path" select="concat($path,'/InitlBaselnSubmissn')"/>
</xsl:call-template>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_InitlBaselnSubmissn_LineItem7_PrtlShipmnt_definition</xsl:with-param>
</xsl:call-template>
</xsl:otherwise>
</xsl:choose>
</div>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_InitlBaselnSubmissn_LineItem7_TrnsShipmnt_definition</xsl:with-param>
</xsl:call-template>
</xsl:otherwise>
</xsl:choose>
</div>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_InitlBaselnSubmissn_RequiredSubmission3_MtchIsseDt_definition</xsl:with-param>
</xsl:call-template>
</xsl:otherwise>
</xsl:choose>
</div>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_InitlBaselnSubmissn_RequiredSubmission3_MtchTrnsprt_definition</xsl:with-param>
</xsl:call-template>
</xsl:otherwise>
</xsl:choose>
</div>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_InitlBaselnSubmissn_RequiredSubmission3_MtchAmt_definition</xsl:with-param>
</xsl:call-template>
</xsl:otherwise>
</xsl:choose>
</div>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_InitlBaselnSubmissn_RequiredSubmission4_MtchIsseDt_definition</xsl:with-param>
</xsl:call-template>
</xsl:otherwise>
</xsl:choose>
</div>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_InitlBaselnSubmissn_RequiredSubmission4_MtchInspctnDt_definition</xsl:with-param>
</xsl:call-template>
</xsl:otherwise>
</xsl:choose>
</div>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_InitlBaselnSubmissn_RequiredSubmission4_AuthrsdInspctrInd_definition</xsl:with-param>
</xsl:call-template>
</xsl:otherwise>
</xsl:choose>
</div>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_InitlBaselnSubmissn_RequiredSubmission4_MtchConsgn_definition</xsl:with-param>
</xsl:call-template>
</xsl:otherwise>
</xsl:choose>
</div>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_InitlBaselnSubmissn_Baseline3_InttToPayXpctd_definition</xsl:with-param>
</xsl:call-template>
</xsl:otherwise>
</xsl:choose>
</div>
...
<xsl:template name="Document_InitlBaselnSubmissn_BuyrBkCtctPrsn_SellrBkCtctPrsn_choice">
<xsl:param name="path"/>
<xsl:variable name="index">
<xsl:number count="InitlBaselnSubmissn"/>
</xsl:variable>
...
<xsl:attribute name="id">
<xsl:value-of select="$path"/>/choice_1/1</xsl:attribute>
<xsl:variable name="label">XSL_TSU_InitlBaselnSubmissn_InitialBaselineSubmissionV03_BuyrBkCtctPrsn_name</xsl:variable>
<xsl:call-template name="radio-field">
<xsl:with-param name="label">
<xsl:value-of select="$label"/>
</xsl:with-param>
...
<xsl:attribute name="id">
<xsl:value-of select="$path"/>/choice_1/2</xsl:attribute>
<xsl:variable name="label">XSL_TSU_InitlBaselnSubmissn_InitialBaselineSubmissionV03_SellrBkCtctPrsn_name</xsl:variable>
<xsl:call-template name="radio-field">
<xsl:with-param name="label">
<xsl:value-of select="$label"/>
</xsl:with-param>
