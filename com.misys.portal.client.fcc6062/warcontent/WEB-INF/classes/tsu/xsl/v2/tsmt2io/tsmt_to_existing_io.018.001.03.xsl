...
<xsl:stylesheet version="1.0"
	...
	<!-- 
	This stylesheet is used for any consecutive new event/transactions, example: Amendment Request or Full Push received at the time of establishment. 
	 -->
	...
	<xsl:variable name="references" select="service:manageReferences('IO', $ioRefId, //tnx_id, //bo_ref_id, //cust_ref_id, //company_id, //PushdThrghBaseln/Buyr/Nm, //buyer_reference, //issuing_bank/abbv_name, '01')"/>
