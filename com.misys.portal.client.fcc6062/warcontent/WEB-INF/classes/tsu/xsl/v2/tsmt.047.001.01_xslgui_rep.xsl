...
<xsl:with-param name="legend">XSL_TSU_SpclReq_SpecialRequestV01_SubmitrTxRef_name</xsl:with-param>
...
<xsl:with-param name="help-label">XSL_TSU_SpclReq_SimpleIdentificationInformation_Id_definition</xsl:with-param>
</xsl:call-template>
</div>
</div>
</xsl:with-param>
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_SpclReq_name</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_SpclReq_SpecialRequestV01_ReqId_name</xsl:with-param>
<xsl:with-param name="legend-type">indented-header</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_SpclReq_MessageIdentification1_Id_definition</xsl:with-param>
</xsl:call-template>
</div>
</xsl:template>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_SpclReq_MessageIdentification1_CreDtTm_definition</xsl:with-param>
</xsl:call-template>
</div>
</xsl:template>
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_SpclReq_SpecialRequestV01_TxId_name</xsl:with-param>
<xsl:with-param name="legend-type">indented-header</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
<xsl:apply-templates select="Id">
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_SpclReq_SpecialRequestV01_Ntfctn_name</xsl:with-param>
<xsl:with-param name="legend-type">indented-header</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
...
<xsl:value-of select="&#10;&#9;&#9;&#9;&#9;&#9;&#9;&#9;localization:getGTPString($language, 'XSL_TSU_SpclReq_Notification1_Tp_code_MWFT')&#10;&#9;&#9;&#9;&#9;&#9;&#9;"/>
</option>
<option value="CSDS">
<xsl:if test=". = 'CSDS'">
<xsl:attribute name="selected"/>
</xsl:if>
<xsl:value-of select="&#10;&#9;&#9;&#9;&#9;&#9;&#9;&#9;localization:getGTPString($language, 'XSL_TSU_SpclReq_Notification1_Tp_code_CSDS')&#10;&#9;&#9;&#9;&#9;&#9;&#9;"/>
</option>
</xsl:when>
<xsl:otherwise>
<xsl:choose>
...
<xsl:with-param name="required">Y</xsl:with-param>
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_SpclReq_Notification1_Tp_definition</xsl:with-param>
</xsl:call-template>
</div>
</xsl:template>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_SpclReq_Notification1_AddtlInf_definition</xsl:with-param>
</xsl:call-template>
</div>
</xsl:template>
</xsl:stylesheet>
