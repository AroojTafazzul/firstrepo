...
<xsl:with-param name="legend">XSL_TSU_StsRptReq_StatusReportRequestV03_NttiesToBeRptd_name</xsl:with-param>
...
<xsl:with-param name="help-label">XSL_TSU_StsRptReq_BICIdentification1_BIC_definition</xsl:with-param>
</xsl:call-template>
</div>
</div>
</xsl:with-param>
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_StsRptReq_name</xsl:with-param>
<xsl:with-param name="legend-type">indented-header</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
...
<xsl:call-template name="fieldset-wrapper">
<xsl:with-param name="legend">XSL_TSU_StsRptReq_StatusReportRequestV03_ReqId_name</xsl:with-param>
<xsl:with-param name="legend-type">indented-header</xsl:with-param>
<xsl:with-param name="content">
<div class="section">
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_StsRptReq_MessageIdentification1_Id_definition</xsl:with-param>
</xsl:call-template>
</div>
</xsl:template>
...
<xsl:with-param name="show-help">Y</xsl:with-param>
<xsl:with-param name="help-label">XSL_TSU_StsRptReq_MessageIdentification1_CreDtTm_definition</xsl:with-param>
</xsl:call-template>
</div>
</xsl:template>
