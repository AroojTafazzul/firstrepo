...
<axsl:template mode="M0" priority="4000" match="/el_tnx_record">
<axsl:choose>
...
<axsl:template mode="M1" priority="4000" match="/el_tnx_record">
...
<axsl:template mode="M2" priority="4000" match="/el_tnx_record">
