...
<axsl:template mode="M0" priority="4000" match="/si_tnx_record">
<axsl:choose>
...
<axsl:template mode="M3" priority="4000" match="/si_tnx_record">
<axsl:if test="tnx_type_code = '01' and          ((cr_avl_by_code = '04' or cr_avl_by_code = '05')           and (not(draft_term) or draft_term = ''))">In pattern tnx_type_code = '01' and ((cr_avl_by_code = '04' or cr_avl_by_code = '05') and (not(draft_term) or draft_term = '')):
...
<axsl:template mode="M4" priority="4000" match="/si_tnx_record">
<axsl:if test="tnx_type_code = '01' and          ((cr_avl_by_code = '02' or cr_avl_by_code = '03')           and ((not(draft_term) or draft_term = '')            or (not(drawee_details_bank/name) or drawee_details_bank_name = '')))">In pattern tnx_type_code = '01' and ((cr_avl_by_code = '02' or cr_avl_by_code = '03') and ((not(draft_term) or draft_term = '') or (not(drawee_details_bank/name) or drawee_details_bank_name = ''))):
...
<axsl:template mode="M5" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M6" priority="4000" match="/si_tnx_record">
<axsl:if test="tnx_type_code = '01' and          (inco_term != '' and (not(inco_place) or inco_place = ''))">In pattern tnx_type_code = '01' and (inco_term != '' and (not(inco_place) or inco_place = '')):
...
<axsl:template mode="M7" priority="4000" match="/si_tnx_record">
<axsl:if test="tnx_type_code = '01' and          ((not(last_ship_date) or last_ship_date = '')           and (not(narrative_shipment_period) or narrative_shipment_period = ''))">In pattern tnx_type_code = '01' and ((not(last_ship_date) or last_ship_date = '') and (not(narrative_shipment_period) or narrative_shipment_period = '')):
...
<axsl:template mode="M8" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M9" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M10" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M11" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M12" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M13" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M14" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M15" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M16" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M17" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M18" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M19" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M20" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M21" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M22" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M23" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M24" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M25" priority="4000" match="/si_tnx_record">
...
<axsl:template mode="M26" priority="4000" match="/si_tnx_record">
