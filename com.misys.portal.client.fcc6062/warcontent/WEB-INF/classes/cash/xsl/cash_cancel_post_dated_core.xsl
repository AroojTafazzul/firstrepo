...
<!--
##########################################################
Templates for cancel post dated payment
...
<xsl:stylesheet 
  ...
  <xsl:include href="../../cash/xsl/cash_cancel_post_dated_details.xsl" />
 ...
 <xsl:template name="js-imports">
  <xsl:call-template name="common-js-imports">
   <xsl:with-param name="binding">misys.binding.cash.cancel_post_dated</xsl:with-param>
   <xsl:with-param name="override-help-access-key">FT_14_CANCEL</xsl:with-param>
  </xsl:call-template>
 </xsl:template>
