...
<xsl:stylesheet version="1.0"
	...
	<xsl:include href="account_statement_content_fo.xsl" />
	<xsl:include href="account_statement_TD_content_fo.xsl" />
	<xsl:template match="/">
			...
			<fo:page-sequence initial-page-number="1"
				...
				<fo:static-content text-align="center" flow-name="xsl-region-start">
					<fo:block font-size="8pt" text-align="center" color="#FFFFFF"
						...
						<xsl:value-of select="localization:getGTPString($language, 'XSL_HEADER_ACCOUNT_STATEMENT')" />
					</fo:block>
				</fo:static-content>
