...
<xsl:stylesheet version="1.0"
	...
	<xsl:include href="fb_content_fo.xsl"/>
			...
			<fo:page-sequence initial-page-number="1" master-reference="Section1-ps">
				...
				<fo:static-content text-align="center" flow-name="xsl-region-start">
					<fo:block font-size="8pt" text-align="center" color="#FFFFFF"
						...
						<xsl:value-of select="localization:getDecode($language, 'N047', fb_tnx_record/sub_product_code[.])"/>
					</fo:block>
				</fo:static-content>
				<!--Apply fb_content_fo.xsl on fb_tnx_record-->
