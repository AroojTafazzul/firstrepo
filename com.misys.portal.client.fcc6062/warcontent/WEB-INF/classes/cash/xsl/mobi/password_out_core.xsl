        ...
        <Message>
            ...
            <Content>
				<Request>
	                ...
	                <PrintRequest>
	                    <PrintRequestType>4</PrintRequestType>
	                    <PrintRequestArgs>
	                        <PrintRequestArg>
	                        ...
	                        <PrintRequestArg>
	                            ...
	                            <PrintRequestArgValue><xsl:value-of select="tools:encryptForMHUB(substring(/user/password_value, 1, 100))" /></PrintRequestArgValue>
	                        </PrintRequestArg>
							<!-- 
	                        <PrintRequestArg>
