...
<!-- Additional JS imports for this form are -->
	...
	<xsl:template name="js-imports">
		<xsl:call-template name="common-js-imports">
			<xsl:with-param name="binding">misys.binding.bank.report_ft_mups</xsl:with-param>
			...
			<xsl:with-param name="legend">XSL_PRIORITY_DETAILS_HEADER</xsl:with-param>
				 <xsl:with-param name="content">
				   	<xsl:call-template name="input-field">
					     	...
					     	<xsl:with-param name="id">clearing_code</xsl:with-param>
					     	<xsl:with-param name="disabled">Y</xsl:with-param>	
							<xsl:with-param name="fieldsize">small</xsl:with-param>
				   			<xsl:with-param name="value" select="clearing_code" />
				   			<xsl:with-param name="override-displaymode">view</xsl:with-param>
					</xsl:call-template>
				</xsl:with-param>
		</xsl:call-template>
					...
					<xsl:with-param name="content">
						...
						<xsl:call-template name="row-wrapper">
							...
							<xsl:with-param name="content">
								<xsl:call-template name="input-field">
				    				    ...
				    				    <xsl:with-param name="maxlength">34</xsl:with-param>	
						...
						<xsl:call-template name="input-field">
				      			...
				      			<xsl:with-param name="size">11</xsl:with-param>
				       			...
				       			<xsl:with-param name="value"><xsl:value-of select="counterparties/counterparty/cpty_bank_swift_bic_code"/></xsl:with-param>	
							    <xsl:with-param name="override-displaymode">view</xsl:with-param>
			            </xsl:call-template>
						<xsl:call-template name="input-field">
