...
<xsl:stylesheet version="1.0" 
			...
			<xsl:call-template name="form-wrapper">
				...
				<xsl:with-param name="content">
					...
					<xsl:if test="$displaymode='edit'">
						<div id="MUPS_DISCLAIMER" class="ftDisclaimer domDisclaimer">
							<xsl:call-template name="simple-disclaimer">
								<xsl:with-param name="label">XSL_FT_MUPS_DISCLAIMER</xsl:with-param>
							</xsl:call-template>
						</div>
					</xsl:if>
					<div>
						...
						<!-- Transfer sections -->						
						<xsl:call-template name="mups-general-details"/>
						...
						<xsl:call-template name ="mups-priority-details"/>
						<xsl:call-template name="mups-transfer-to-details" />
						<xsl:call-template name="mups-transaction-details" />
						<!-- FX Snippets Start -->
							...
							<!-- FX Snippets End -->  
						<xsl:call-template name="mups-notify-beneficiary-details" />

						 <xsl:call-template name="transaction-notes-details" /> 
		    ...
		    <xsl:with-param name="content">
				<div class="widgetContainer">
					...
					<xsl:if test="$displaymode='view'">
					    ...
					    <xsl:with-param name="value"><xsl:value-of select="clearing_code"/></xsl:with-param>
				    	</xsl:call-template>
				    </xsl:if>
					<xsl:call-template name="hidden-field">
	...
	<xsl:template name="js-imports">
		<xsl:call-template name="common-js-imports">
			<xsl:with-param name="binding">misys.binding.cash.create_ft_mups</xsl:with-param>
			<xsl:with-param name="override-help-access-key">
			     <xsl:choose>
			       <xsl:when test="$option ='CANCEL'">FT_CANCEL</xsl:when>
			       <xsl:otherwise>FT_INR</xsl:otherwise>
			     </xsl:choose>
 		  </xsl:with-param> 
		</xsl:call-template>
		<script>
	...
	<xsl:template name="mups-transaction-details">	 	
		<xsl:call-template name="fieldset-wrapper">
			...
			<xsl:with-param name="content">		
				...
				<xsl:with-param name="content">
					...
					<xsl:if test="not(amount_access) or  (amount_access[.='true'])  ">
						...
						<xsl:call-template name="input-field">
							<xsl:with-param name="label">XSL_MUPS_DESCRIPTION_ADDRESS_HEADER</xsl:with-param>
							<xsl:with-param name="name">mups_description_address_line_1</xsl:with-param>
							<xsl:with-param name="fieldsize">medium</xsl:with-param>
							<xsl:with-param name="maxsize">34</xsl:with-param>
							<xsl:with-param name="swift-validate">N</xsl:with-param>
							<xsl:with-param name="value"><xsl:value-of select="mups_description_address_line_1"/></xsl:with-param>
						</xsl:call-template>
						<xsl:call-template name="input-field">
							<xsl:with-param name="name">mups_description_address_line_2</xsl:with-param>
							<xsl:with-param name="fieldsize">medium</xsl:with-param>
							<xsl:with-param name="maxsize">34</xsl:with-param>
							<xsl:with-param name="swift-validate">N</xsl:with-param>
							<xsl:with-param name="value"><xsl:value-of select="mups_description_address_line_2"/></xsl:with-param>
						</xsl:call-template>
						<xsl:call-template name="input-field">
							<xsl:with-param name="name">mups_description_address_line_3</xsl:with-param>
							<xsl:with-param name="fieldsize">medium</xsl:with-param>
							<xsl:with-param name="maxsize">34</xsl:with-param>
							<xsl:with-param name="swift-validate">N</xsl:with-param>
							<xsl:with-param name="value"><xsl:value-of select="mups_description_address_line_3"/></xsl:with-param>
						</xsl:call-template>
						<xsl:call-template name="input-field">
							<xsl:with-param name="name">mups_description_address_line_4</xsl:with-param>
							<xsl:with-param name="maxsize">34</xsl:with-param>
							<xsl:with-param name="fieldsize">medium</xsl:with-param>
							<xsl:with-param name="swift-validate">N</xsl:with-param>
							<xsl:with-param name="value"><xsl:value-of select="mups_description_address_line_4"/></xsl:with-param>
						</xsl:call-template>
						</xsl:when>
						<xsl:otherwise>
							<xsl:call-template name="input-field">
			...
			<!-- some hidden fields -->
						...
						<xsl:call-template name="hidden-field">
							...
							<xsl:with-param name="value">MUPS</xsl:with-param>
						</xsl:call-template>
						<xsl:call-template name="hidden-field">
							<xsl:with-param name="name">rtgsallowedamt</xsl:with-param>
							<xsl:with-param name="value"><xsl:value-of select="defaultresource:getResource('MUPS_RTGS_MINIMUM_ALLOWED_AMOUNT')"/></xsl:with-param>
						</xsl:call-template>
						<xsl:call-template name="hidden-field">
							<xsl:with-param name="name">decrValue</xsl:with-param>
							<xsl:with-param name="value"><xsl:value-of select="defaultresource:getResource('MUPS_DESCRIPTION_VALIDATION_REGEX')"/></xsl:with-param>
						</xsl:call-template>
						<xsl:call-template name="hidden-field">
						...
						<xsl:call-template name="hidden-field">
							...
							<xsl:with-param name="value"><xsl:value-of select="bene_adv_beneficiary_id"/></xsl:with-param>
						</xsl:call-template>	
						<xsl:call-template name="hidden-field">
	...
	<xsl:template name="mups-general-details">
				...
				<xsl:choose>
					<xsl:when test="bulk_ref_id[.!='']">
						...
						<xsl:call-template name="user-account-field">
				          ...
				          <xsl:with-param name="product_types">FT:MUPS</xsl:with-param>
					...
					<xsl:otherwise>
						...
						<xsl:call-template name="input-field">
							...
							<xsl:with-param name="value"><xsl:value-of select="localization:getDecode($language, 'N047', 'MUPS')"/></xsl:with-param>
							<xsl:with-param name="override-displaymode">view</xsl:with-param>
						</xsl:call-template>
						<xsl:if test="entities[number(.) &gt; 0]">
							<xsl:call-template name="entity-field">
							    ...
							    <xsl:with-param name="override-sub-product-code">FT:MUPS</xsl:with-param>
						    </xsl:call-template>
						</xsl:if>
	...
	<xsl:template name="mups-notify-beneficiary-details">
		    							...
		    							<xsl:if test="notify_beneficiary_choice[.='default_email']">
		    								<span id="notify_beneficiary_email_node">
		    									<div trim="true" dojoType="dijit.form.ValidationTextBox" name="notify_beneficiary_email" id="notify_beneficiary_email" 
		    										maxLength="512" size="35" class="medium" value="{notify_beneficiary_email}">
		    										<xsl:if test="not(notify_beneficiary[.='Y'])">
		    											<xsl:attribute name="disabled">disabled</xsl:attribute>
		    										</xsl:if>
		    									</div>
	...
	<xsl:template name = "mups-priority-details">
	<xsl:choose>
		<xsl:when test="$displaymode='edit' and bulk_ref_id [.='']">
		<xsl:call-template name = "fieldset-wrapper">
			<xsl:with-param name="legend">XSL_PRIORITY_DETAILS_HEADER</xsl:with-param>		
			<xsl:with-param name="content">
			<xsl:call-template name="column-container">
					<xsl:with-param name="content">
				   <xsl:call-template name="column-wrapper">
					<xsl:with-param name="content">
						<xsl:call-template name="select-field">
							...
							<xsl:call-template name="hidden-field">
						    	<xsl:with-param name="name">ifsc_neft</xsl:with-param>
						    	<xsl:with-param name="value"/>
				   			</xsl:call-template>
				   			<xsl:call-template name="hidden-field">
						    	<xsl:with-param name="name">ifsc_rtgs</xsl:with-param>
						    	<xsl:with-param name="value"/>
				   			</xsl:call-template>
						</xsl:with-param>
						</xsl:call-template>
	...
	<xsl:template name="mups-transfer-to-details">
		  ...
		  <xsl:with-param name="legend">XSL_HEADER_TRANSFER_TO_DETAILS</xsl:with-param>
			 ...
			 <xsl:call-template name="column-container">
				   ...
				   <xsl:call-template name="column-wrapper">
					<xsl:with-param name="content">
						<xsl:call-template name="input-field">
							<xsl:with-param name="label">XSL_BENEFICIARYDETAILS_NAME</xsl:with-param>
						...
						<xsl:call-template name="hidden-field">
								<xsl:with-param name="name">beneficiary_acc_name_regex_mups</xsl:with-param>
						...
						<xsl:call-template name="row-wrapper">
							...
							<xsl:with-param name="content">
								<xsl:if test="$displaymode = 'edit' or ($displaymode ='view' and sub_product_code[.='MUPS'])">
			    					<div> 
			    				...
			    				<xsl:call-template name="input-field">
			    				    ...
			    				    <xsl:with-param name="readonly"><xsl:if test="$pre-approved_beneficiary_only or pre_approved_status ='Y'">Y</xsl:if></xsl:with-param>
			    				    <xsl:with-param name="regular-expression"><xsl:value-of select="defaultresource:getResource('BENEFICIARY_ACCOUNT_NO_VALIDATION_REGEX_MUPS')"/></xsl:with-param>
			    				</xsl:call-template>
							</xsl:with-param>
						</xsl:call-template>
						...
						<xsl:call-template name="input-field">
				      			...
				      			<xsl:with-param name="size">11</xsl:with-param>
				       			...
				       			<xsl:with-param name="swift-validate">N</xsl:with-param>
							    <xsl:with-param name="value"><xsl:if test="sub_product_code = 'MUPS'"><xsl:value-of select="counterparties/counterparty/cpty_bank_swift_bic_code"/></xsl:if></xsl:with-param>	
			                    <xsl:with-param name="readonly"><xsl:if test="$pre-approved_beneficiary_only or pre_approved_status ='Y'">Y</xsl:if></xsl:with-param>	     			  
						</xsl:call-template>
						<xsl:choose>
			                 <xsl:when test="bulk_ref_id[.!='']">
							     <xsl:if test="not($pre-approved_beneficiary_only) and $displaymode='edit'">
						    		<xsl:call-template name="button-wrapper">
										<xsl:with-param name="label">XSL_ALT_IFSC</xsl:with-param>
										<xsl:with-param name="show-image">Y</xsl:with-param>
										<xsl:with-param name="show-border">N</xsl:with-param>
			    		...
			    		<xsl:call-template name="input-field">
				      			...
				      			<xsl:with-param name="size">35</xsl:with-param>
				       			...
				       			<xsl:with-param name="readonly">Y</xsl:with-param>
				       			<xsl:with-param name="swift-validate">Y</xsl:with-param>
				      			<xsl:with-param name="value"><xsl:value-of select="counterparties/counterparty/cpty_bank_name"/></xsl:with-param>
				    	</xsl:call-template>
			    		...
			    		<xsl:call-template name="input-field">
			    			<xsl:with-param name="label">XSL_BENEFICIARY_IFSC_BANK_ADDRESS</xsl:with-param>
			      			...
			      			<xsl:with-param name="size">35</xsl:with-param>
			       			...
			       			<xsl:with-param name="readonly">Y</xsl:with-param>
			       			<xsl:with-param name="swift-validate">N</xsl:with-param>
			      			<xsl:with-param name="value"><xsl:value-of select="counterparties/counterparty/cpty_bank_address_line_1"/></xsl:with-param>
			    		</xsl:call-template>
			    		...
			    		<xsl:call-template name="input-field">
			      			...
			      			<xsl:with-param name="size">35</xsl:with-param>
			       			...
			       			<xsl:with-param name="readonly">Y</xsl:with-param>
			       			<xsl:with-param name="swift-validate">N</xsl:with-param>
			      			<xsl:with-param name="value"><xsl:value-of select="counterparties/counterparty/cpty_bank_address_line_2"/></xsl:with-param>
			    		</xsl:call-template>
			    		...
			    		<xsl:call-template name="input-field">
				      			...
				      			<xsl:with-param name="size">35</xsl:with-param>
				       			...
				       			<xsl:with-param name="readonly">Y</xsl:with-param>
				       			<xsl:with-param name="swift-validate">N</xsl:with-param>
				      			<xsl:with-param name="value"><xsl:value-of select="counterparties/counterparty/cpty_bank_dom"/></xsl:with-param>
				    	</xsl:call-template>
	...
	<!--
  	 Transaction Notes Details Fieldset. 
   	-->
	<xsl:template name="transaction-notes-details">
		<xsl:if test="$displaymode='edit'">
	   		<div id="MUPS_NOTES_DISCLAIMER" class="ftDisclaimer mupsDisclaimer">
				<xsl:call-template name="simple-disclaimer">
					<xsl:with-param name="label">XSL_FT_MUPS_NOTES_DISCLAIMER</xsl:with-param>
				</xsl:call-template>
			</div>
		</xsl:if>
	</xsl:template>	
