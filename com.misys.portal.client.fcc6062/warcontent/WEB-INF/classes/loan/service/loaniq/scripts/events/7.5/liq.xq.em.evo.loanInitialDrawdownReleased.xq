declare function liq.xq.em.evo.loanInitialDrawdownReleased($evo){
<ln_tnx_record
...
<rem_inst_pay_method>{$evo/eventOwner/cashflowsClerk/borrowerAgentCashflow/remittanceInstruction/remittanceMethod}</rem_inst_pay_method>
