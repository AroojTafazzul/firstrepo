...
<facility>
	...
	{for $ofpe in /AccruedFee[LIQ.XQS.EQUAL(@facilityId, $facility_id)][LIQ.XQS.EQUAL(@dealId, $dealId)][LIQ.XQS.EQUAL(@category, 'ONG')][LIQ.SQL.PREDICATE("FEE_CDE_OBJ_STATE IN ('RELSD')")] return
