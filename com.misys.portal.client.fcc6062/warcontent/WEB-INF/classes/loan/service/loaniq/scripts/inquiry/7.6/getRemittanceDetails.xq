...
<remittanceInstruction>			
           ...
           <standardInd>{$ri/scr/standardInstructionInd}</standardInd>
			<loanProductIndicator>{$ri/scr/loanProductIndicator}</loanProductIndicator>
			<sblcProductIndicator>{$ri/scr/sblcProductIndicator}</sblcProductIndicator>
			<principalIndicator>{$ri/scr/principalIndicator}</principalIndicator>
			<interestIndicator>{$ri/scr/interestIndicator}</interestIndicator>
			<feesIndicator>{$ri/scr/feesIndicator}</feesIndicator>
			<incomingTransferIndicator>{$ri/scr/incomingTransferIndicator}</incomingTransferIndicator>
			<outgoingTransferIndicator>{$ri/scr/outgoingTransferIndicator}</outgoingTransferIndicator>
