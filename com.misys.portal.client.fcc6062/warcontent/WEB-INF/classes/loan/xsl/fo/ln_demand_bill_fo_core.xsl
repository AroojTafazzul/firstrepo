			...
			<fo:page-sequence force-page-count="no-force" master-reference="page-master-0" initial-page-number="auto" format="1">
				<fo:flow flow-name="xsl-region-body">
					<fo:block>
												...
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BillTextHeader">
															<xsl:for-each select="DemandBill">
													...
													<fo:inline>
														<xsl:value-of select="/BillTextHeader/DemandBill/BillForContacts/BillForContact/BillingContact/CustomerAddress/line1"/>
													</fo:inline>
													<fo:block/>
													<fo:inline>
														<xsl:text>&#160;</xsl:text>
													...
													<fo:inline>
														<xsl:value-of select="/BillTextHeader/DemandBill/BillForContacts/BillForContact/BillingContact/CustomerAddress/line2"/>
													</fo:inline>
													<fo:block/>
													<fo:inline>
														<xsl:text>&#160;</xsl:text>
													...
													<fo:inline>
														<xsl:value-of select="/BillTextHeader/DemandBill/BillForContacts/BillForContact/BillingContact/CustomerAddress/line3"/>
													</fo:inline>
													<fo:block/>
													<fo:inline>
														<xsl:text>&#160;</xsl:text>
													...
													<fo:inline>
														<xsl:value-of select="concat(/BillTextHeader/DemandBill/BillForContacts/BillForContact/BillingContact/CustomerAddress/line4 ,  &apos; &apos;,/BillTextHeader/DemandBill/BillForContacts/BillForContact/BillingContact/CustomerAddress/line5, &apos; &apos;, /BillTextHeader/DemandBill/BillForContacts/BillForContact/BillingContact/CustomerAddress/line6)"/>
													</fo:inline>
													<fo:block/>
													<fo:inline>
														<xsl:text>&#160;</xsl:text>
													...
													<fo:inline>
														<xsl:value-of select="/BillTextHeader/DemandBill/BillForContacts/BillForContact/BillingContact/CustomerAddress/city"/>
													</fo:inline>
													<fo:inline>
														<xsl:text>&#160;</xsl:text>
													</fo:inline>
													<fo:inline>
														<xsl:value-of select="/BillTextHeader/DemandBill/BillForContacts/BillForContact/BillingContact/CustomerAddress/stateCode"/>
													</fo:inline>
													<fo:inline>
														<xsl:text>&#160;</xsl:text>
													</fo:inline>
													<fo:inline>
														<xsl:value-of select="/BillTextHeader/DemandBill/BillForContacts/BillForContact/BillingContact/CustomerAddress/zip"/>
													</fo:inline>
													<fo:block/>
													<xsl:for-each select="$XML">
														<xsl:for-each select="BillTextHeader">
						...
						<xsl:if test="/BillTextHeader/DemandBill/BillForContacts/BillForContact/BillAssociationOwners/BillAssociationOwner/BillAssociationsForOwner/BillAssociation/Accrual/AccrualCycle/@id != &apos;&apos;">
							<fo:inline>
																								...
																								<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																									<fo:block-container overflow="hidden">
																										<fo:block text-align="center">
																											...
																											<fo:inline font-size="7pt">
																												<xsl:value-of select="concat((/BillTextHeader/DemandBill/BillForContacts/BillForContact/BillAssociationOwners/BillAssociationOwner/BillAssociationsForOwner/BillAssociation/Accrual/AccrualLineItems/AccrualLineItem/accrualRate * 100), &apos;%&apos;)"/>
																											</fo:inline>
																										</fo:block>
																									</fo:block-container>
																								</fo:table-cell>
						...
						<xsl:choose>
							<xsl:when test="/BillTextHeader/DemandBill/BillForContacts/PrincipalRemittanceInstruction/@id !=&apos;&apos;">
								<fo:block>
									<fo:leader leader-pattern="space"/>
								</fo:block>
								<fo:inline font-size="10pt">
							...
							<xsl:when test="/BillTextHeader/DemandBill/BillForContacts/BillForContact/RemittanceInstructions/SingleRemittanceInstruction/@id != &apos;&apos;">
								<fo:block>
									<fo:leader leader-pattern="space"/>
								</fo:block>
								<fo:inline font-size="10pt">
							...
							<xsl:when test="/BillTextHeader/DemandBill/BillForContacts/BillForContact/RemittanceInstructions/InterestRemittanceInstruction/@id !=&apos;&apos;">
								<fo:block>
									<fo:leader leader-pattern="space"/>
								</fo:block>
								<fo:inline font-size="10pt">
							...
							<xsl:when test="/BillTextHeader/DemandBill/BillForContacts/BillForContact/RemittanceInstructions/SBLCFeesRemittanceInstruction/@id !=&apos;&apos;">
								<fo:block>
									<fo:leader leader-pattern="space"/>
								</fo:block>
								<fo:inline>
