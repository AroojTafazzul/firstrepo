...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="ln_reprice_content_fo.xsl"/>
    <xsl:template match="/">
            ...
            <fo:page-sequence initial-page-number="1"
				...
				<fo:static-content text-align="center" flow-name="xsl-region-start">
					<fo:block font-size="8pt" text-align="center" color="#FFFFFF"
						...
						<xsl:value-of select="localization:getDecode($language, 'N001', ln_tnx_record/product_code[.])"/>
					</fo:block>
				</fo:static-content>
				<!--Apply ln_content_fo.xsl on ln_tnx_record-->
