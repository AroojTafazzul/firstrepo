...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="pooling_structure">
		<result>
			...
			<com.misys.portal.cash.product.lbo.common.PoolingStructureTnx>
				...
				<xsl:if test="COPY_STRUCTURE_ID">
				<copy_structure_id>
					<xsl:value-of select="copy_structure_id" />
				</copy_structure_id>
				</xsl:if>
	...
	<xsl:template name="balGrpTemplate">		
       ...
       <xsl:variable name="balgrp_id">
		...
		<com.misys.portal.cash.product.lbo.common.BalancingGroupTnx>			
	...
	<xsl:template name="balsubGrpTemplate">	
       <xsl:param name="company1"/>
		...
		<com.misys.portal.cash.product.lbo.common.BalancingSubGroupTnx>			
	...
	<xsl:template name ="acctsubGrpTemplate">
		    ...
		    <xsl:param name="subGroupId"/>
		    <xsl:param name="subGroupCode"/>
		<com.misys.portal.cash.product.lbo.common.AccountSubGroupTnx>
