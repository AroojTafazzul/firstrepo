	...
	<xsl:template match="product_file_set/in_tnx_record">
		...
		<result subobject='true'>
			...
			<com.misys.portal.product.common.Bank role_code="01">
				...
				<xsl:if test="product_file_set/in_tnx_record/issuing_bank/name"><name><xsl:value-of select="product_file_set/in_tnx_record/issuing_bank/name"/></name></xsl:if>
				<xsl:if test="product_file_set/in_tnx_record/main_bank_name and not(product_file_set/in_tnx_record/issuing_bank/name)"><name><xsl:value-of select="product_file_set/in_tnx_record/main_bank_name"/></name></xsl:if>
				<xsl:if test="product_file_set/in_tnx_record/issuing_bank/address_line_1"><address_line_1><xsl:value-of select="product_file_set/in_tnx_record/issuing_bank/address_line_1"/></address_line_1></xsl:if>
				<xsl:if test="product_file_set/in_tnx_record/issuing_bank/address_line_2"><address_line_2><xsl:value-of select="product_file_set/in_tnx_record/issuing_bank/address_line_2"/></address_line_2></xsl:if>
				<xsl:if test="product_file_set/in_tnx_record/issuing_bank/dom"><dom><xsl:value-of select="product_file_set/in_tnx_record/issuing_bank/dom"/></dom></xsl:if>
				<xsl:if test="product_file_set/in_tnx_record/issuing_bank/iso_code"><iso_code><xsl:value-of select="product_file_set/in_tnx_record/issuing_bank/iso_code"/></iso_code></xsl:if>
				<xsl:if test="product_file_set/in_tnx_record/issuing_bank/reference"><reference><xsl:value-of select="product_file_set/in_tnx_record/issuing_bank/reference"/></reference></xsl:if>
