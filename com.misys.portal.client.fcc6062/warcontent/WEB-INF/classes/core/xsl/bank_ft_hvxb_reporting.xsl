...
<!--
##########################################################
CNAPS Domestic Fund Transfer (FT-HVXB) Form.
...
<!-- Additional JS imports for this form are -->
	...
	<xsl:template name="js-imports">
		<xsl:call-template name="common-js-imports">
			<xsl:with-param name="binding">misys.client.binding.bank.cash.report_ft_hvxb</xsl:with-param>
	...
	<xsl:template name="hvxb-transfer-to-details">
		<xsl:variable name="pre-approved_beneficiary_only" select="not(securitycheck:hasPermission(utils:getUserACL($rundata),'ft_regular_beneficiary_access',utils:getUserEntities($rundata)))"/>
	   	...
	   	<!-- Transfer to options for HVXB transfer -->
		<xsl:call-template name="fieldset-wrapper">
					...
					<xsl:with-param name="content">
						...
						<xsl:with-param name="content">
						  ...
						  <xsl:call-template name="input-field">
						    ...
						    <xsl:with-param name="required">N</xsl:with-param>			
							<xsl:with-param name="value"><xsl:if test="sub_product_code = 'HVXB'"><xsl:value-of select="cnaps_bank_name"/></xsl:if></xsl:with-param>
						    <!-- <xsl:with-param name="readonly"><xsl:if test="$pre-approved_beneficiary_only or pre_approved_status ='Y'">Y</xsl:if></xsl:with-param> -->
