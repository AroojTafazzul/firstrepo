...
<xsl:stylesheet 
 ...
 <xsl:template name="js-imports">
  <xsl:call-template name="system-common-js-imports">
   ...
   <xsl:with-param name="binding">misys.binding.system.company</xsl:with-param>
  </xsl:call-template>
 </xsl:template>
  	...
  	<xsl:call-template name="fieldset-wrapper">
   		...
   		<xsl:with-param name="content">
    		...
    		<xsl:call-template name="select-field">
     			...
     			<xsl:with-param name="value"><xsl:value-of select="channel[@selected='true' and type = '01' and (news_destination ='03')]/id"/></xsl:with-param>
     			<xsl:with-param name="options">
     				<option></option>
