...
<xsl:stylesheet 
 ...
 <xsl:template name="matrix-details">
   <xsl:call-template name="fieldset-wrapper">
    <xsl:with-param name="legend">MENU_CHANGE_AUTHORISATION</xsl:with-param>
    ...
    <xsl:if test="$option='BANK_AUTHORISATION_MAINTENANCE' or $option='BANK_AUTHORISATION_MAINTENANCE_MC'">
    ...
    <xsl:if test="$option='CUSTOMER_AUTHORISATION_MAINTENANCE'">
		<xsl:call-template name="input-field">
    		<xsl:with-param name="label">XSL_JURISDICTION_COMPANY</xsl:with-param>
  ...
  <xsl:if test="$override_company_abbv_name =''">
