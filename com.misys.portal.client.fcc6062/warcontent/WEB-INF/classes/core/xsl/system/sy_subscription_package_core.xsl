    			...
    			<xsl:call-template name="input-field">
     			...
     			<xsl:call-template name="checkbox-field">
    				<xsl:with-param name="label">XSL_JURISDICTION_SUBSCRIPTION_PACKAGE_APPLY_TAX</xsl:with-param>
      				<xsl:with-param name="name">taxed</xsl:with-param>
					<xsl:with-param name="checked-label">Apply Local Tax</xsl:with-param>
					<xsl:with-param name="unchecked-label">Apply Local Tax</xsl:with-param> 
     			</xsl:call-template>
     			</xsl:if>
     		</xsl:with-param>
  		</xsl:call-template>
    ...
    <xsl:with-param name="content">
     <div class="widgetContainer">
      ...
      <xsl:call-template name="hidden-field">
       ...
       <xsl:with-param name="value">SUBSCRIPTION_PACKAGE_MAINTENANCE</xsl:with-param>
      </xsl:call-template>
      <xsl:call-template name="hidden-field">
