...
<xsl:stylesheet 
  ...
  <xsl:template match="/">
	<xsl:apply-templates select="banks_record"/>
  </xsl:template>
  
  <xsl:template match="banks_record">
   <!-- Loading message  -->
 ...
 <xsl:template name="js-imports">
  <xsl:call-template name="system-common-js-imports">
   <xsl:with-param name="xml-tag-name">banks_record</xsl:with-param>
   <xsl:with-param name="binding">misys.binding.system.bank_company</xsl:with-param>
  </xsl:call-template>
 </xsl:template>
    ...
    <xsl:with-param name="content">
     <div class="widgetContainer">
      ...
      <xsl:call-template name="hidden-field">
       ...
       <xsl:with-param name="value">CUSTOMER_BANKS_MAINTENANCE</xsl:with-param>
      </xsl:call-template>
      <xsl:call-template name="hidden-field">
	  ...
	  <xsl:call-template name="hidden-field">
    	...
    	<xsl:with-param name="value"><xsl:value-of select="static_company/abbv_name"/></xsl:with-param>
   	  </xsl:call-template>	     
     </div>
    </xsl:with-param>
   </xsl:call-template>
