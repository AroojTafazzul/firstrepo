...
<!--
##########################################################
Third Party Trade Fund Transfer (FT-TTPT) Form.
		  	...
		  	-->
		  		<xsl:call-template name="fieldset-wrapper">   		
		  		 ...
		  		 <xsl:call-template name="recurring_content">
			    	...
			    	<xsl:call-template name="ttpt-transfer-to-details" />
					<xsl:call-template name="ttpt-transaction-details" /> 
  ...
  <xsl:template name="bank_details">
	...
	<xsl:template name="js-imports">
		<xsl:call-template name="common-js-imports">
			<xsl:with-param name="binding">misys.binding.bank.report_ft_ttpt</xsl:with-param>
	...
	<xsl:template name="ttpt-transfer-to-details">
		<xsl:call-template name="fieldset-wrapper">
		  <xsl:with-param name="legend">XSL_HEADER_TRANSFER_TO_DETAILS</xsl:with-param>
			  <xsl:with-param name="content">
				...
				<!-- This Empty div is to show inline for TTPT product , used in JS -->				
				<div class="CUR"/>
	...
	<xsl:template name="ttpt-transaction-details">	 	
		<xsl:call-template name="fieldset-wrapper">
