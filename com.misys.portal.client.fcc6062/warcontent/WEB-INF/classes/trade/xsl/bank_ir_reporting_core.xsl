 ...
 <!-- 
  ...
  <xsl:call-template name="fieldset-wrapper">
       ...
       <xsl:call-template name="fieldset-wrapper">
        ...
        <xsl:with-param name="content">
        <xsl:if test="$displaymode='edit' or ($displaymode='view' and narrative_payment_details[.!=''])">
         <div>
       ...
       <xsl:if test="$displaymode='edit' or ($displaymode='view' and (act_no[.!=''] or fwd_contract_no[.!='']))">
  ...
  <xsl:call-template name="common-js-imports">
   <xsl:with-param name="binding">misys.binding.bank.report_ir</xsl:with-param>
		   ...
		   <xsl:choose>
			   	...
			   	<xsl:otherwise>IR</xsl:otherwise>
		   </xsl:choose>
	  </xsl:with-param>
  </xsl:call-template>
 </xsl:template>
  ...
  <xsl:call-template name="fieldset-wrapper">
   ...
   <xsl:with-param name="content">
    ...
    <xsl:call-template name="input-field">
     ...
     <xsl:if test="$displaymode='view' and ref_id[.!='']">
     ...
     <xsl:call-template name="fieldset-wrapper">
      ...
      <xsl:with-param name="content">
       <xsl:call-template name="address">
        ...
        <xsl:with-param name="search-button-type">bank-beneficiary</xsl:with-param>
    ...
    <xsl:call-template name="fieldset-wrapper">
     ...
     <xsl:with-param name="content">
      <xsl:call-template name="address">
       ...
       <xsl:with-param name="search-button-type">remitter</xsl:with-param>
      </xsl:call-template>
      <xsl:call-template name="input-field">
         <xsl:with-param name="label">XSL_PARTIESDETAILS_REFERENCE</xsl:with-param>
         <xsl:with-param name="name">remitter_reference</xsl:with-param>
	         <xsl:with-param name="value">
		         <xsl:variable name="ref"><xsl:value-of select="remitter_reference"/></xsl:variable>
  ...
  <xsl:call-template name="fieldset-wrapper">
   ...
   <xsl:with-param name="content">
    ...
    <xsl:call-template name="input-field">
     ...
     <xsl:with-param name="currency-value"><xsl:value-of select="//*[name()='ir_cur_code']"/></xsl:with-param>
     <xsl:with-param name="required">Y</xsl:with-param>
     <xsl:with-param name="value">
