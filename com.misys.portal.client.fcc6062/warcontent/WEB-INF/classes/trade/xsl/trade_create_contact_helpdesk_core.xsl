...
Contact Helpdesk (SE) Form, Customer Side.
...
<xsl:stylesheet 
  ...
  <xsl:template name="hidden-fields">
   <div class="widgetContainer">
    ...
    <!-- Fix for MPG-6310 and MPS-40541 to include product code for search -->
    <xsl:call-template name="hidden-field">
   ...
   <xsl:call-template name="hidden-field">
    ...
    <xsl:with-param name="value">CTCHP</xsl:with-param>
   </xsl:call-template>
   <xsl:call-template name="hidden-field">
   ...
   <xsl:choose>
		<xsl:when test="$displaymode='edit'">
			   ...
			   <xsl:call-template name="input-field">
			    ...
			    <xsl:with-param name="override-displaymode">none</xsl:with-param>
			   </xsl:call-template>
  ...
  <xsl:template name="bank-details">
		<xsl:if test="//se_tnx_record/issuing_bank/abbv_name[.!=''] and $displaymode='view'">
			<xsl:call-template name="fieldset-wrapper">
    			<xsl:with-param name="legend">XSL_PAYMENTDETAILS_DRAWEE_DETAILS_ISSUING_BANK</xsl:with-param>
    				<xsl:with-param name="content">
    					<xsl:call-template name="input-field">
						    ...
						    <xsl:with-param name="value" select="//se_tnx_record/issuing_bank/name" />
						    <xsl:with-param name="override-displaymode">view</xsl:with-param>
					    </xsl:call-template>
					</xsl:with-param>
   			</xsl:call-template>
					     ...
					     <xsl:call-template name="row-wrapper">
					      ...
					      <xsl:with-param name="content">
					       <xsl:call-template name="textarea-field">
						        ...
						        <xsl:with-param name="label">XSL_CREATE_CONTACT_HELPDESK_FREE_FORMAT_TEXT_LABEL</xsl:with-param>
