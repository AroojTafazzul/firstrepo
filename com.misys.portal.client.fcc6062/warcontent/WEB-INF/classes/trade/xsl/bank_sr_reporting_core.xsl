   ...
   <xsl:call-template name="build-inco-terms-data"/>
    ...
    <div id="transactionDetails">
     ...
     <xsl:call-template name="form-wrapper">
      ...
      <xsl:choose>
			 <xsl:when test="($displaymode = 'view' and (not($swift2018Enabled))) or ($displaymode = 'edit' and (not($swift2018Enabled)) or ($displaymode = 'edit' and $swift2018Enabled and (tnx_type_code[.='01'] or (tnx_type_code[.='13'] and sub_tnx_type_code[.='12' or .='19']))) )">
  ...
  <xsl:call-template name="common-js-imports">
   ...
   <xsl:with-param name="override-help-access-key">
	   <xsl:choose>
	   	...
	   	<xsl:when test="tnx_type_code[.='01']">SR_01</xsl:when>	   	
  ...
  <div class="widgetContainer">
   ...
   <xsl:call-template name="hidden-field">
    ...
    <xsl:call-template name="hidden-field">
      		...
      		<xsl:with-param name="value" select="org_previous_file/sr_tnx_record/narrative_description_goods"/>
   	</xsl:call-template> 
   	<xsl:call-template name="hidden-field">
      		<xsl:with-param name="name">org_narrative_documents_required</xsl:with-param>
      		<xsl:with-param name="value" select="org_previous_file/sr_tnx_record/narrative_documents_required"/>
   	</xsl:call-template> 
   	<xsl:call-template name="hidden-field">
      	<xsl:with-param name="name">org_narrative_additional_instructions</xsl:with-param>
      	<xsl:with-param name="value" select="org_previous_file/sr_tnx_record/narrative_additional_instructions"/>
   	</xsl:call-template>
   	<xsl:call-template name="hidden-field">
      		<xsl:with-param name="name">org_narrative_special_beneficiary</xsl:with-param>
      		<xsl:with-param name="value" select="org_previous_file/sr_tnx_record/narrative_special_beneficiary"/>
   	</xsl:call-template>
   	<xsl:call-template name="hidden-field">
      		<xsl:with-param name="name">org_narrative_special_recvbank</xsl:with-param>
      		<xsl:with-param name="value" select="org_previous_file/sr_tnx_record/narrative_special_recvbank"/>
   	</xsl:call-template>
    <xsl:call-template name="hidden-field">
