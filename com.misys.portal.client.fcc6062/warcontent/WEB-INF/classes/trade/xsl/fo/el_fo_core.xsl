...
<xsl:stylesheet version="1.0"
	...
	<xsl:include href="el_content_fo.xsl" />
	<xsl:template match="/">
			...
			<fo:page-sequence initial-page-number="1"
				...
				<fo:static-content text-align="center" flow-name="xsl-region-start">
					<fo:block font-size="8pt" text-align="center" color="#FFFFFF"
						...
						<xsl:value-of select="localization:getDecode($language, 'N001', el_tnx_record/product_code[.])"/>
					</fo:block>
				</fo:static-content>
				<!--Apply el_content_fo.xsl on el_tnx_record-->
