...
<xsl:stylesheet version="1.0"
	...
	<xsl:include href="si_content_fo.xsl" />
	<xsl:template match="/">
			...
			<fo:page-sequence initial-page-number="1"
				...
				<fo:static-content text-align="center" flow-name="xsl-region-start">
					<fo:block font-size="8pt" text-align="center" color="#FFFFFF"
						...
						<xsl:value-of select="localization:getDecode($language, 'N001', si_tnx_record/product_code[.])"/>
					</fo:block>
				</fo:static-content>
				<!--Apply si_content_fo.xsl on si_tnx_record-->
