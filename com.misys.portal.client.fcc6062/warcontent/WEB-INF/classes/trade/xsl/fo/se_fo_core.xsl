...
<xsl:stylesheet version="1.0"
	...
	<xsl:include href="se_content_fo.xsl" />
	<xsl:template match="/">
			...
			<fo:page-sequence initial-page-number="1"
				...
				<fo:static-content text-align="center" flow-name="xsl-region-start">
					<fo:block font-size="8pt" text-align="center" color="#FFFFFF"
						...
						<xsl:value-of select="localization:getDecode($language, 'N047', se_tnx_record/sub_product_code[.])"/>
					</fo:block>
				</fo:static-content>
				<!--Apply se_content_fo.xsl on se_tnx_record-->
