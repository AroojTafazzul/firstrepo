    ...
    <fo:flow flow-name="xsl-region-body" font-family="serif" font-size="11.0pt">
												...
												<fo:table-row>
													<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" height="25pt">
														...
														<xsl:if test="Body/RoutingSummary/MeansOfTransport/SeaTransportIdentification">
															<fo:block text-align="center">
																<xsl:value-of select="Body/RoutingSummary/MeansOfTransport/SeaTransportIdentification/VoyageDetails/departureDate"/>
															</fo:block>
														</xsl:if>
													...
													<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" height="25pt">
														...
														<xsl:if test="Body/RoutingSummary/MeansOfTransport/SeaTransportIdentification">
															<fo:block text-align="center">
																...
																<xsl:text> </xsl:text>
																<xsl:value-of select="Body/RoutingSummary/MeansOfTransport/SeaTransportIdentification/VoyageDetails/voyageNumber"/>
															</fo:block>
														</xsl:if>
														<xsl:if test="Body/RoutingSummary/MeansOfTransport/FlightDetails">
															<fo:block text-align="center">
					...
					<fo:table>
						...
						<fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell>
									<xsl:if test="Body/LineItemDetails/LineItem">
							...
							<!-- Charges -->
							<xsl:if test="Body/GeneralChargesOrDiscounts/LumpSumChargeWithDocumentIdentifier">
								<fo:table-row>
									<fo:table-cell>
