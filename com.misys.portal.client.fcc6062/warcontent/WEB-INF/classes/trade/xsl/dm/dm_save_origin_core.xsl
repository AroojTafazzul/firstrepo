...
-->
			...
			<com.misys.portal.product.dm.common.DocumentInstance>
				...
				<xsl:if test="type[.='01']">
					...
					<xsl:element name="data">
						<xsl:element name="CertificateOfOrigin" xmlns:gtp="http://www.neomalogic.com" xmlns:cmp="http://www.bolero.net">
							<!--Header: empty so far -->
							...
							<xsl:element name="Body">
								...
								<xsl:element name="Parties">
									...
									<!-- The buyer doesn't exist for certificate of origin -->
									<!--
								...
								<xsl:element name="RoutingSummary">
									<!-- Routing summary doesn't exist in DTD
								...
								<xsl:element name="ConsignmentDetail">
									<xsl:element name="Product">
										<xsl:element name="productName">
											<xsl:value-of select="product_description_1"/>
										</xsl:element>
										<xsl:element name="ProductIdentifiers">
											<xsl:element name="productIdentification">
												<xsl:value-of select="product_reference_1"/>
											</xsl:element>
										</xsl:element>
										<xsl:element name="ProductQuantity">
											<xsl:element name="value">
												<xsl:value-of select="product_quantity_1"/>
											</xsl:element>
											<xsl:element name="unitOfMeasureCode">
												<xsl:value-of select="product_unit_1"/>
											</xsl:element>
										</xsl:element>
									</xsl:element>
								</xsl:element>
	...
	<!--**************************-->
	<xsl:template name="PRODUCT_SUMMARY" xmlns:gtp="http://www.neomalogic.com" xmlns:cmp="http://www.bolero.net">
