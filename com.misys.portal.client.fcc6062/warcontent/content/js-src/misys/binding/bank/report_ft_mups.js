/*
 * ---------------------------------------------------------- 
 * Event Binding for india domestic transfers
 * 
 * Copyright (c) 2000-2018 Finastra (http://www.misys.com), All Rights Reserved.
 * 
 * version: 1.0 date: 06/11/2018
 * 
 * ----------------------------------------------------------
 */
dojo.provide("misys.binding.bank.report_ft_mups");
...
(function(/*Dojo*/d, /*Dijit*/dj, /*Misys*/m) {
	...
	d.mixin(m, {		
       ...
       dojo.require('misys.client.binding.bank.report_ft_mups_client');