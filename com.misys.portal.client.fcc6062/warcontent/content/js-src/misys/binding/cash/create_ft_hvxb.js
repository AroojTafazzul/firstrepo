/*
 * ---------------------------------------------------------- 
 * Event Binding for CNAPS cross border transfers
 * 
 ...
 * ----------------------------------------------------------
 */
dojo.provide("misys.binding.cash.create_ft_hvxb");
...
(function(/*Dojo*/d, /*Dijit*/dj, /*Misys*/m) {
	...
	function _changeBeneficiaryNotificationEmail()
	{
		...
		{
			d.place(notifyEmailDOM, notifyRadio2DOM, "after");
			//dj.byId("notify_beneficiary_email").set("disabled",false);
		}
		else
		{
			if (!email)
...
//
	...
	d.mixin(m, {		
		...
		bind : function()
		{
			...
			dj.byId("sub_product_code").set("value", "HVXB");	
