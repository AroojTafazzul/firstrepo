dojo.provide("misys.binding.openaccount.payment_oa");
/*
 ----------------------------------------------------------
 Event Binding for
...
dojo.require("misys.openaccount.widget.PaymentTransportFreightCharges");
dojo.require("misys.openaccount.widget.PaymentInsuranceRequiredClauses");
dojo.require("misys.openaccount.widget.PaymentInsuranceRequiredClause");
dojo.require("misys.openaccount.widget.PaymentInsuranceRequiredConditions");
...
dojo.require("misys.openaccount.widget.PaymentOtherCertificateDatasets");
dojo.require("misys.openaccount.widget.PaymentCertificateDatasetDetail");
dojo.require("misys.openaccount.widget.PaymentCertificateDatasetDetails");
dojo.require("misys.openaccount.widget.PaymentRoutingSummary");
dojo.require("misys.openaccount.widget.PaymentAirRoutingSummaries");
...
(function(/*Dojo*/d, /*Dijit*/dj, /*Misys*/m) {
	...
	d.mixin(m, {
		...
		bind : function() {
			...
			{
				m.toggleMutuallyExclusiveMandatoryFields(["adjustment_rate","adjustment_amt"]);
			});
			...
			{
				m.toggleMutuallyExclusiveMandatoryFields(["freight_charge_rate","freight_charge_amt"]);
			});
			...
			{
				m.toggleMutuallyExclusiveMandatoryFields(["tax_amt","tax_rate"]);
			});
			...
			m.connect("settlement_bic","onClick", function() {
				if(dj.byId("creditor_agent_name") && dj.byId("creditor_agent_bic") && dj.byId("creditor_street_name") && 
						dj.byId("creditor_post_code_identification") && dj.byId("creditor_town_name") &&
						 ...
						 dj.byId("settlement_bic") && dj.byId("settlement_bic").get("checked")) 
				{
			...
			m.connect("settlement_name_address","onClick", function() {
				if(dj.byId("creditor_agent_name") && dj.byId("creditor_agent_bic") && dj.byId("creditor_street_name") &&
						dj.byId("creditor_post_code_identification") && dj.byId("creditor_town_name") &&
						dj.byId("creditor_country_sub_div") && dj.byId("creditor_country") &&
						 dj.byId("settlement_name_address") && dj.byId("settlement_name_address").get("checked")) 
				{
			...
			m.connect("bpo_used_status", "onChange", function() {
				if(dj.byId("bpo_used_status") && dj.byId("add_bpo_button") && dj.byId("bpo_used_status").get("checked"))
				{
					dj.byId("add_bpo_button").set("disabled",false);
				}
				else if(dj.byId("bpo_used_status") && dj.byId("add_bpo_button") && !dj.byId("bpo_used_status").get("checked"))
				{
			...
			m.connect("buyer_bank_bpo","onClick",function() {
				if(dj.byId("buyer_bank_bpo_added") && dj.byId("buyer_bank_bpo_added").get("value") !== "true" && dj.byId("buyer_bank_bpo").get("checked"))
				{
				...
				else if(dj.byId("buyer_bank_bpo_added") && dj.byId("buyer_bank_bpo_added").get("value") !== "true" && !dj.byId("buyer_bank_bpo").get("checked"))
				{
					dj.byId("obligor_bank").set("value","");
					dj.byId("obligor_bank").set("disabled",false);
				}
				else if(dj.byId("buyer_bank_bpo_added") && dj.byId("buyer_bank_bpo_added").get("value") !== "false" && !dj.byId("buyer_bank_bpo").get("checked"))
				{
					dj.byId("buyer_bank_bpo_added").set("value",false);
					dj.byId("obligor_bank").set("value","");
					dj.byId("obligor_bank").set("disabled",false);
			...
			m.connect("settlement_bic" , "onChange", function() {
				if(dj.byId("settlement_bic") && dj.byId("settlement_bic").get("checked"))
				{
			...
			m.connect("settlement_name_address" , "onChange", function() {
				if(dj.byId("settlement_name_address") && dj.byId("settlement_name_address").get("checked"))
				{
			...
			m.connect("creditor_account_iban","onChange", function() {
				if(dj.byId("creditor_account_iban") && dj.byId("creditor_account_iban").get("checked")) {
			...
			m.connect("creditor_account_bban","onChange", function() {
				if(dj.byId("creditor_account_bban") && dj.byId("creditor_account_bban").get("checked")) {
			...
			m.connect("creditor_account_upic","onChange", function() {
				if(dj.byId("creditor_account_upic") && dj.byId("creditor_account_upic").get("checked")) {
			...
			m.connect("creditor_account_prop","onChange", function() {
				if(dj.byId("creditor_account_prop") && dj.byId("creditor_account_prop").get("checked")) {
			...
			m.connect("creditor_act_type_code","onChange", function() {
				if(dj.byId("creditor_act_type_code") && dj.byId("creditor_act_type_code").get("checked")) {
			...
			m.connect("creditor_act_type_prop","onChange", function() {
				if(dj.byId("creditor_act_type_prop") && dj.byId("creditor_act_type_prop").get("checked")) {
			...
			m.connect("pmt_code","onChange", function() {
				if(dj.byId("pmt_code") && dj.byId("pmt_code").get("checked")) {
			...
			m.connect("pmt_other_term_code","onChange", function() {
				if(dj.byId("pmt_other_term_code") && dj.byId("pmt_other_term_code").get("checked")) {
		...
		onFormLoad : function() {
			...
			// Save formToXml string on the form load for handling close IO transaction
			formXml = m.formToXML();
			var productStatus = dj.byId("prodstatus");
			var tnxtype = dj.byId("tnxtype");
			...
			//Clear the BPO Expiry Date on form load for Copy From IO.
			if(dj.byId("isCopyFrom") && dj.byId("isCopyFrom").get("value") === "Y"){
				m.clearBpoExpiryDateOnLoad();
			}
			
			// BPO Settlement Terms
			if(dj.byId("creditor_agent_bic") && dj.byId("settlement_bic") && !dj.byId("settlement_bic").get("checked")) {
				dj.byId("creditor_agent_bic").set("disabled",true);
				dj.byId("creditor_agent_bic").set("required",false);
			} 
		...
		beforeSubmitValidations : function() {
			...
			//Validate close comments only, for close IO.
			if(dj.byId("tnxtype") && dj.byId("tnxtype").get("value") === "38" ){
			...
			else if(dj.byId("tnxtype") && dj.byId("tnxtype").get("value") === "55")
				{
					return valid;
				}
			else {
				...
				if(dj.byId("po_ref_id") && dj.byId("po_ref_id").get("state") === "Error"){
...
//Including the client specific implementation
       dojo.require('misys.client.binding.openaccount.payment_oa_client');