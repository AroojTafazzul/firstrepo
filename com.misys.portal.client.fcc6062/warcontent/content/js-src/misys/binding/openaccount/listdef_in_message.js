dojo.provide("misys.binding.openaccount.listdef_in_message");
...
(function(/*Dojo*/d, /*dj*/dj, /*Misys*/m) {
	...
	d.mixin(m._config, {
		...
		submitOpenAccount : function(programcode,subtnxtypecode) {
			...
			m.grid.processRecords(grids, "/screen/AjaxScreen/action/RunGroupSubmission?s=InvoiceScreen&operation=SUBMIT&option=IN_EARLY_PAYMENT_REQUEST&mode=DRAFT&tnxtype=13&referenceid="+referenceid+"&tnxid="+tnxid+"&programcode="+programcode+"&sub_tnx_type_code="+subtnxtypecode);
		},
	...
	function _setAmountValue() {
       ...
       dojo.require('misys.client.binding.openaccount.listdef_in_message_client');