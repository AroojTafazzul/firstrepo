dojo.provide("misys.binding.openaccount.simplified_upload_ip_template");
/*
-----------------------------------------------------------------------------
...
dojo.require('misys.client.binding.openaccount.simplified_upload_ip_template_client');