dojo.provide("misys.binding.openaccount.listdef_in_financerepayment_request");

/*
-----------------------------------------------------------------------------
Scripts for the list def binding for Invoice
...
(function(/*Dojo*/d, /*dj*/dj, /*Misys*/m) {	
	d.mixin(m, {
       ...
       dojo.require('misys.client.binding.openaccount.listdef_in_financerepayment_request_client');