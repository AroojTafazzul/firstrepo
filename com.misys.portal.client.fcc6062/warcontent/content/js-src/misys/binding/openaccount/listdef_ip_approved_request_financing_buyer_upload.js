/**
 * 
 */dojo.provide("misys.binding.openaccount.listdef_ip_approved_request_financing_buyer_upload");
/*
-----------------------------------------------------------------------------
	...
	d.mixin(m._config, {
		submitOpenAccount : function(programcode,subtnxtypecode) {
			...
			if(keys === ""){
				...
				m.post({action:URL, params:[{name:'list_keys',value:keys}, {name:'programcode',value:'06'}, {name:'base_ccy',value:baseCcy}, {name:'operation',value:'MULTI_LIST'}]});
			}
		},		
