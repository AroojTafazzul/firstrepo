 ...
 *//**
 * 
 */dojo.provide("misys.binding.openaccount.listdef_in_financing_request");
/*
-----------------------------------------------------------------------------
...
(function(/*Dojo*/d, /*dj*/dj, /*Misys*/m) {
	...
	d.mixin(m._config, {
		submitOpenAccount : function(/*String*/ productCode) {
			...
			else
			{
				...
				m.post({action:URL, params:[{name:"list_keys",value:keys}, {name:"base_ccy",value:baseCcy}, {name:"operation",value:"MULTI_LIST_FINANCING"},{name:"option",value:"IN_FINANCE_REQUEST"},{name:"mode",value:"DRAFT"},{name:"productcode",value:"IN"}]});
			}
		},		
	...
	function _validateDueToDate() {
       ...
       dojo.require("misys.client.binding.openaccount.listdef_in_financing_request_client");