dojo.provide("misys.binding.dialog.beneficiary");
...
(function(/*Dojo*/d, /*Dijit*/dj, /*Misys*/m) {
	...
	d.mixin(m.dialog, {
		bind: function(){
		// dont require this as we are using x char regex from portal.properties now
       ...
       dojo.require('misys.client.binding.dialog.beneficiary_client');