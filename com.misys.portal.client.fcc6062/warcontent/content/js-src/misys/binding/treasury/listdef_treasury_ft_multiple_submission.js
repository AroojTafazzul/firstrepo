dojo.provide("misys.binding.treasury.listdef_treasury_ft_multiple_submission");

/*
-----------------------------------------------------------------------------
Scripts for the list def binding for Multiple Submission of Treasury FT
...
(function(/*Dojo*/d, /*dj*/dj, /*Misys*/m) {
	...
	d.mixin(m._config, {
		...
		submitFXOrder : function() {
				...
				m._config.processRecords(grids, "/screen/AjaxScreen/action/TreasuryMultipleFTSubmission?s=TreasuryFundTransferScreen&mode=UNSIGNED&tnxtype=01&referenceid="+referenceid+"&tnxid="+tnxid);
		},
 	 ...
 	 _processRecords : function( /*Dijit._widget | Array of grids*/ grids,
       ...
       dojo.require('misys.client.binding.openaccount.listdef_treasury_ft_multiple_submission_client');
