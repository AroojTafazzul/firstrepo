dojo.provide("misys.openaccount.widget.TransportByRoadReceiptPlaceDetail");
...
// our declared class
dojo.declare("misys.openaccount.widget.TransportByRoadReceiptPlaceDetail",
	[ dijit._Widget, dijit._Contained, misys.layout.SimpleItem ],
	// class properties:
	{
	ref_id: '',
	tnx_id: '',
	road_receipt_place_name: '',
	is_valid: "Y",
	...
	routing_summary_id: '',
		...
		{
			var item = {
					road_receipt_place_name	: this.get("road_receipt_place_name"),
		...
		{
			console.debug("[TransportByRoadReceiptPlaceDetail] constructor");
		}
	}
);