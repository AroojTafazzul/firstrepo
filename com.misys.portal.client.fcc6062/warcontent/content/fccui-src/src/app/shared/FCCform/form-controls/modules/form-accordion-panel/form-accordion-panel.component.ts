...
@Component({
  selector: 'fcc-form-accordion-panel',
  templateUrl: './form-accordion-panel.component.html',
  styleUrls: ['./form-accordion-panel.component.scss'],
})
export class FormAccordionPanelComponent
  extends FCCBase
