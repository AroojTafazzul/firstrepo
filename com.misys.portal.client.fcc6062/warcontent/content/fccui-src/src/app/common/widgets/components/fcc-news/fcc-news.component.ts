...
@Component({
  selector: 'fcc-common-news',
  templateUrl: './fcc-news.component.html',
  styleUrls: ['./fcc-news.component.scss'],
  animations: [OPEN_CLOSE_ANIMATION]
})
export class FccNewsComponent implements OnInit, AfterViewChecked {
  syndicatedNews: any[] = [];
  internalnews: any[] = [];
  contextPath: any;
