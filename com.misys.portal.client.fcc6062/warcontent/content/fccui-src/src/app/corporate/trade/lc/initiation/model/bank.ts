 ...
 * issuing bank._  _'Issuance request' is the initial event that creates the ILC transaction event. This event could only be
 *  created once per ILC. If changes to the basic details of the ILC are needed, an 'Amendment request' event could be
...
/**
 * Used for defining the various Banks such as Issuing Bank, Advising Bank and Advise Through bank, involved in this Import
 * letter of credit transaction
 */
export class Bank {
    /**
     * The unique name of the bank
     */
    shortName?: string;
    /**
     * The name of the bank to be added
     */
    name?: string;
    /**
