...
@Component({
  selector: 'app-li-product',
  templateUrl: './li-product.component.html',
  styleUrls: ['./li-product.component.scss']
})
export class LiProductComponent extends TransactionComponent implements OnInit {
  ...
  constructor(
    ...
    return this.liProductService.beforeSaveValidation();
    }

    beforeSubmitValidation(): boolean {
      return this.liProductService.beforeSubmitValidation();
    }
