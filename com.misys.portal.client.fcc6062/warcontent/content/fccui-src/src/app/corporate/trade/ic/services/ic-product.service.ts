...
export class IcProductService implements ProductValidator {
  ...
  validate() {
    let isValid = false;
    const sectionForm = this.productStateService.getSectionData('icGeneralDetails', FccGlobalConstant.PRODUCT_IC);
