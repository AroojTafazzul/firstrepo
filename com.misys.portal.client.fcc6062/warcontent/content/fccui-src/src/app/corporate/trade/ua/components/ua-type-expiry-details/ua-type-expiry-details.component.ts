...
@Component({
  selector: 'app-ua-type-expiry-details',
  templateUrl: './ua-type-expiry-details.component.html',
  providers: [{ provide: HOST_COMPONENT, useExisting: UaTypeExpiryDetailsComponent }]
})
export class UaTypeExpiryDetailsComponent extends UaProductComponent implements OnInit {
