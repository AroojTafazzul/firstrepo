...
@Component({
  selector: 'app-ua-shipment-details',
  templateUrl: './ua-shipment-details.component.html',
  providers: [{ provide: HOST_COMPONENT, useExisting: UaShipmentDetailsComponent }]
})
export class UaShipmentDetailsComponent extends UaProductComponent implements OnInit {
...
initializeFormGroup() {
  this.form = this.productStateService.getSectionData(this.sectionName, FccGlobalConstant.PRODUCT_BR);
