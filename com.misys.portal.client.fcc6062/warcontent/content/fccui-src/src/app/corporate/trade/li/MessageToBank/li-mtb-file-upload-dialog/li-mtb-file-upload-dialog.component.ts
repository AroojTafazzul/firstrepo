...
@Component({
  selector: 'app-li-mtb-file-upload-dialog',
  templateUrl: './li-mtb-file-upload-dialog.component.html',
  styleUrls: ['./li-mtb-file-upload-dialog.component.scss'],
  providers: [{ provide: HOST_COMPONENT, useExisting: LiMtbFileUploadDialogComponent }]
})
export class LiMtbFileUploadDialogComponent extends LiProductComponent implements OnInit {
