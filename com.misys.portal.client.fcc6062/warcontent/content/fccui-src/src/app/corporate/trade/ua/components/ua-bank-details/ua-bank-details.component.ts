...
@Component({
  selector: 'app-ua-bank-details',
  templateUrl: './ua-bank-details.component.html',
  providers: [{ provide: HOST_COMPONENT, useExisting: UaBankDetailsComponent }]
})
export class UaBankDetailsComponent extends UaProductComponent implements OnInit {
  module = ``;
  form: FCCFormGroup;
...
initializeFormGroup() {
  const sectionName = FccGlobalConstant.UA_BANK_DETAILS;
