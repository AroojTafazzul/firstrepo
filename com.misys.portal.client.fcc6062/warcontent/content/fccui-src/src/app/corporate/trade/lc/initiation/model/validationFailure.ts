...
/**
 * Field validation failure. This will enable the user interface to highlight field with error.
 */
export class ValidationFailure {
    ...
    title?: string;
    /**
     * Field where error occurs
     */
    field?: string;
    /**
     * The value of the field where the error occurred
     */
    fieldValue?: string;
}
