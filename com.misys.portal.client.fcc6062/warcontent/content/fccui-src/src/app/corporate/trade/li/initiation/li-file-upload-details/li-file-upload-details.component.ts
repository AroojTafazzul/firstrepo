...
import { LiFileUploadDialogComponent } from '../li-file-upload-dialog/li-file-upload-dialog.component';
...
@Component({
  selector: 'fcc-li-file-upload-details',
  templateUrl: './li-file-upload-details.component.html',
  styleUrls: ['./li-file-upload-details.component.scss'],
  providers: [{ provide: HOST_COMPONENT, useExisting: LiFileUploadDetailsComponent }]
})
export class LiFileUploadDetailsComponent extends LiProductComponent implements OnInit {
  ...
  constructor(protected commonService: CommonService, protected sessionValidation: SessionValidateService,
              ...
              this.module = this.translateService.instant('liFileUploadDetails');
  }

  @ViewChild(LiFileUploadDialogComponent) public fileDialogReference;
  ...
  ngOnInit() {
    ...
    if (this.stateService.getSectionData('liFileUploadDetails').get('attachments').value[FccGlobalConstant.DOC_ID]) {
      this.renderBrowseButton(this.stateService.getSectionData('liFileUploadDetails')
    ...
    initializeFormGroup() {
      const sectionName = 'liFileUploadDetails';
      let bankType = true;
  ...
  onClickBrowseButton() {
    ...
    const dialogRef = this.dialogService.open(LiFileUploadDialogComponent, {
  ...
  ngOnDestroy() {
    ...
    //   }
    this.stateService.setStateSection('liFileUploadDetails', this.form);
  }

  onClickNext() {
    this.saveFormObject();
    this.saveDraftService.changeSaveStatus('liFileUploadDetails',
    this.stateService.getSectionData('liFileUploadDetails'));
  }
