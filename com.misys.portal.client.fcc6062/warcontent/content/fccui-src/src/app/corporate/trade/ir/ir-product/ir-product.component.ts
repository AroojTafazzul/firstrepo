...
@Component({
  selector: 'app-ir-product',
  templateUrl: './ir-product.component.html',
  styleUrls: ['./ir-product.component.scss']
})
export class IrProductComponent extends TransactionComponent implements OnInit {
  ...
  constructor(protected eventEmitterService: EventEmitterService,
              ...
              protected irProductService: IrProductService) {
  ...
  beforeSaveValidation(): boolean {
    return this.irProductService.beforeSaveValidation(this.form);
  }

  beforeSubmitValidation(): boolean {
    return this.irProductService.beforeSubmitValidation();
  }
