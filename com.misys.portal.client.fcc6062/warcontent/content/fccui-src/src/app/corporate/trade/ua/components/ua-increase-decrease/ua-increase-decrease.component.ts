...
@Component({
  selector: 'app-ua-increase-decrease',
  templateUrl: './ua-increase-decrease.component.html',
  providers: [{ provide: HOST_COMPONENT, useExisting: UaIncreaseDecreaseComponent }]
})
export class UaIncreaseDecreaseComponent extends UaProductComponent implements OnInit {
  module = ``;
  form: FCCFormGroup;
