...
@Component({
  selector: 'app-ua-narrative',
  templateUrl: './ua-narrative.component.html',
  providers: [{ provide: HOST_COMPONENT, useExisting: UaNarrativeComponent }]
})
export class UaNarrativeComponent extends UaProductComponent implements OnInit {
  module = ``;
  form: FCCFormGroup;
