...
import { EcFileUploadDialogComponent } from '../ec-file-upload-dialog/ec-file-upload-dialog.component';
...
@Component({
  selector: 'app-ec-file-upload-details',
  templateUrl: './ec-file-upload-details.component.html',
  styleUrls: ['./ec-file-upload-details.component.scss'],
  providers: [{ provide: HOST_COMPONENT, useExisting: EcFileUploadDetailsComponent }]
})
export class EcFileUploadDetailsComponent extends EcProductComponent implements OnInit, OnDestroy {
  ...
  constructor(protected commonService: CommonService, protected sessionValidation: SessionValidateService,
              ...
              protected fileHandlingService: FileHandlingService, protected searchLayoutService: SearchLayoutService,
    ...
    this.module = this.translateService.instant('ecFileUploadDetails');
  }

  @ViewChild(EcFileUploadDialogComponent) public fileDialogReference;
  ...
  ngOnInit() {
    ...
    if (this.stateService.getSectionData('ecFileUploadDetails').get('attachments').value[FccGlobalConstant.DOC_ID]) {
      this.renderBrowseButton(this.stateService.getSectionData('ecFileUploadDetails')
    ...
    initializeFormGroup() {
      const sectionName = 'ecFileUploadDetails';
  ...
  checkValidFileName(file: any) {
    ...
    const dialogRef = this.dialogService.open(EcFileUploadDialogComponent, {
