 ...
 * Received' events can be created multiple times and at any point in the ILC lifecycle prior to its expiry._  _Issuance request
 * can be for the final issuance of letter of credit by the issuing bank or if this request is marked as "Provisional", then it
 *  is for vetting the text of the letter of credit by the issuing bank. On finalisation of the text between the corporate
...
export class IssuingBank {
    /**
     * The unique name of the issuing bank
     */
    bankShortName?: string;
    /**
     * The reference id assigned to the Letter of Credit by the Issuing bank
     */
