...
@Component({
  selector: 'app-ft-trade-upload-dialog',
  templateUrl: './ft-trade-upload-dialog.component.html',
  styleUrls: ['./ft-trade-upload-dialog.component.scss'],
  providers: [{ provide: HOST_COMPONENT, useExisting: FtTradeUploadDialogComponent }]
})
export class FtTradeUploadDialogComponent extends FtTradeProductComponent implements OnInit {
  ...
  constructor(protected commonService: CommonService, protected sessionValidation: SessionValidateService,
              ...
              protected stateService: ProductStateService, protected fileArray: FilelistService,
