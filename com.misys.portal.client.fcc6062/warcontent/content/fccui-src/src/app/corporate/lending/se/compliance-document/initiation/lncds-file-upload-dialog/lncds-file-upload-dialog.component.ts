...
import { ConfirmationService, DialogService, DynamicDialogRef, Table } from 'primeng';
...
@Component({
  selector: 'app-lncds-file-upload-dialog',
  templateUrl: './lncds-file-upload-dialog.component.html',
  styleUrls: ['./lncds-file-upload-dialog.component.scss'],
  providers: [{ provide: HOST_COMPONENT, useExisting: LncdsFileUploadDialogComponent }]
})
export class LncdsFileUploadDialogComponent extends LncdsProductComponent implements OnInit {
