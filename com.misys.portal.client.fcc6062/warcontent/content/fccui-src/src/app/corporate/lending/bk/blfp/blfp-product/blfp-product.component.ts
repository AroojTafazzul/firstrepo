...
@Component({
  selector: 'app-blfp-product',
  templateUrl: './blfp-product.component.html',
  styleUrls: ['./blfp-product.component.scss']
})
export class BlfpProductComponent extends TransactionComponent implements OnInit {
  ...
  validate() {
    ...
    if (this.tnxTypeCode !== FccGlobalConstant.N002_INQUIRE) {
      sectionForm = this.productStateService.getSectionData(FccGlobalConstant.BLFP_GENERAL_DETAILS, FccGlobalConstant.PRODUCT_BK);
