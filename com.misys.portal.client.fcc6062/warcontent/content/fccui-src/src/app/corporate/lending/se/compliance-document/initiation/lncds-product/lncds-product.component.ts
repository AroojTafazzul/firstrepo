...
@Component({
  selector: 'app-lncds-product',
  templateUrl: './lncds-product.component.html',
  styleUrls: ['./lncds-product.component.scss']
})
export class LncdsProductComponent extends TransactionComponent implements OnInit {
  ...
  validate() {
    ...
    if (this.tnxTypeCode !== FccGlobalConstant.N002_INQUIRE) {
      sectionForm = this.productStateService.getSectionData(FccGlobalConstant.LNCDS_GENERAL_DETAILS, FccGlobalConstant.PRODUCT_SE);
