...
@Component({
  selector: 'fcc-blfp-file-upload-dialog',
  templateUrl: './blfp-file-upload-dialog.component.html',
  styleUrls: ['./blfp-file-upload-dialog.component.scss'],
  providers: [{ provide: HOST_COMPONENT, useExisting: BlfpFileUploadDialogComponent }]
})
export class BlfpFileUploadDialogComponent extends BlfpProductComponent implements OnInit {
