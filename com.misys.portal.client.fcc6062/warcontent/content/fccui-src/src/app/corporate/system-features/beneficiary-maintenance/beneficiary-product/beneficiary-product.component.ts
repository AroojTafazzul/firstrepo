...
@Component({
  selector: 'app-beneficiary-product',
  templateUrl: './beneficiary-product.component.html',
  styleUrls: ['./beneficiary-product.component.scss']
})
export class BeneficiaryProductComponent extends TransactionComponent implements OnInit {
  ...
  beforeSaveValidation(): boolean {
    return this.beneficiaryProductService.beforeSaveValidation(this.form);
  }
  ...
  beforeSubmitValidation(): boolean {
    return this.beneficiaryProductService.beforeSubmitValidation();
  }
}
