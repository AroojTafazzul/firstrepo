...
import { FcmPaymentBatchRoutes } from './fcm-payment-batch.routes';
import { BatchGeneralDetailsComponent } from './batch-general-details/batch-general-details.component';
import { BatchProductComponent } from './batch-product/batch-product.component';
import { PaymentBatchDynamicComponent } from '../model/payment-batch-dynamic.component';
import { BatchPaymentAccordionComponent } from './batch-payment-accordion/batch-payment-accordion.component';


@NgModule({
  declarations: [
    PaymentBatchDynamicComponent,
    BatchGeneralDetailsComponent,
...
export class FcmPaymentBatchModule { }
