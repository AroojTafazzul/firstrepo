...
@Component({
  selector: 'app-td-cstd-product',
  templateUrl: './td-cstd-product.component.html',
  styleUrls: ['./td-cstd-product.component.scss']
})
export class TdCstdProductComponent extends TransactionComponent implements OnInit {
  ...
  constructor(protected eventEmitterService: EventEmitterService,
              ...
              protected tdCstdProductService: TdCstdProductService) {
  ...
  beforeSaveValidation(): boolean {
    return this.tdCstdProductService.beforeSaveValidation(this.form);
  }
  ...
  beforeSubmitValidation(): boolean {
    return this.tdCstdProductService.beforeSubmitValidation();
  }
}
