...
import { AppComponent, CheckTimeoutService, CommonService, FccGlobalConfiguration, ResolverService, UtilityService, CustomHeaderService, FormControlResolverService } from 'fccui';
    ...
    constructor(
        ...
        @Inject(DOCUMENT) public document: any, protected metaService: Meta) {
            super(translate, router, commonService, fccGlobalConfiguration, checkTimeoutService,
                activatedRoute, titleService, customHeaderService, dateAdapter, resolverService, utilityService,formControlResolver, document, metaService);
    }
}    
